...
/*! @name APTX LL vendor and codec identifiers
*/
/*@{ */
#define APTX_LL_VENDOR_ID0     0xD7    /* QTI company ID 215 */
#define APTX_LL_VENDOR_ID1      0x0
#define APTX_LL_VENDOR_ID2      0x0
#define APTX_LL_VENDOR_ID3      0x0
#define APTX_LL_CODEC_ID0       0x2
#define APTX_LL_CODEC_ID1       0x0
#define APTX_LL_SBC_BIDIR       0x1
#define APTX_LL_NEW_CAPS        0x2
#define APTX_LL_RESERVED        0x0
/*@} */
...
#else
    APTX_LL_RESERVED + APTX_LL_NEW_CAPS,
#endif
    APTX_LL_RESERVED, /* Decoder doesn't store any values */
    APTX_LL_RESERVED, /* These are just sent from the encoder */
    APTX_LL_RESERVED, /* during caps exchange */
    APTX_LL_RESERVED,
    APTX_LL_RESERVED,
    APTX_LL_RESERVED,
    APTX_LL_RESERVED,
