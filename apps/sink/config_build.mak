...
ifneq (,$(findstring ENABLE_USB,$(DEFS)))
    ...
    ifneq (,$(findstring ENABLE_CHARGER_V2,$(DEFS)))
        USED_MODULES+=sink_usb_charger_v2_def.xml
    else
...
ifneq (,$(findstring ENABLE_BATTERY_OPERATION,$(DEFS)))
    ...
    ifneq (,$(findstring ENABLE_CHARGER_V2,$(DEFS)))
        USED_MODULES+=sink_power_manager_charger_v2_def.xml
    else
        USED_MODULES+=sink_power_manager_charger_v1_def.xml
    endif
endif
...
ifneq (,$(findstring ENABLE_EXT_CHARGER,$(DEFS)))
    USED_MODULES+=sink_ext_charger_module_def.xml
endif
