...
{
    AudioPluginInitMicPio(sinkAudioGetMic1AParams());
    AudioPluginInitMicPio(sinkAudioGetMic1BParams());
    AudioPluginInitMicPio(sinkAudioGetMic2AParams());
    AudioPluginInitMicPio(sinkAudioGetMic2BParams());
}
