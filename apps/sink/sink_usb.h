...
#ifdef ENABLE_CHARGER_V2
    usb_i_pchg,                    /* Current when connected to an unrecognised or floating proprietary charger */
#endif
...
DESCRIPTION
    Store the voltages on the USB data lines
...
#else
#define usbUpdateDataLines(attached_status, dp, dm) ((void)(0))
#endif
...
#if defined(ENABLE_USB)
#define sinkUsbIsEnumerated() (USB_RUNDATA.enumerated)
#else
