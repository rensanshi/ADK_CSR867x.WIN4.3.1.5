...
# check if broadcast audio is to be included
ifneq (, $(findstring -DENABLE_BROADCAST_AUDIO,$(DEFS)))
# copy in the receiver csb decoder 
#image/csb_receiver/csb_receiver.kap :
#	$(mkdir) image/csb_receiver
#	$(copyfile) ../../kalimba/apps/csb_receiver/image/csb_receiver/csb_receiver.kap $@

#image.fs : image/csb_receiver/csb_receiver.kap

# copy in the broadcaster sbc decoder 
#image/csb_broadcaster_sbc_decoder/csb_broadcaster_sbc_decoder.kap :
#	$(mkdir) image/csb_broadcaster_sbc_decoder
#	$(copyfile) ../../kalimba/apps/csb_broadcaster/image/csb_broadcaster_sbc_decoder/csb_broadcaster_sbc_decoder.kap $@

#image.fs : image/csb_broadcaster_sbc_decoder/csb_broadcaster_sbc_decoder.kap

# copy in the broadcaster aac decoder 
#image/csb_broadcaster_aac_decoder/csb_broadcaster_aac_decoder.kap :
#	$(mkdir) image/csb_broadcaster_aac_decoder
#	$(copyfile) ../../kalimba/apps/csb_broadcaster/image/csb_broadcaster_aac_decoder/csb_broadcaster_aac_decoder.kap $@

#image.fs : image/csb_broadcaster_aac_decoder/csb_broadcaster_aac_decoder.kap
endif
