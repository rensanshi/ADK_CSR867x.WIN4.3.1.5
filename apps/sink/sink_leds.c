...
#if HW_VARIANT==H13672v2 || HW_VARIANT==R13568v4
/* The CSRA68100 Development board has 6 LEDs */
...
bool LedsInErrorMode(void)
{
    return (bool)LED_DATA->gErrorMode;
}
