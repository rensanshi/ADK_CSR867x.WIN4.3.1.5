...
DESCRIPTION
     Check if inquiry_scan_enabled is enabled.
RETURNS
     success or failure
****************************************************************************/
bool sinkInquiryIsInquiryScanEnabled(void)
{
     return (GINQDATA.inquiry_scan_enabled)?(TRUE):(FALSE);
}
/****************************************************************************
NAME
...
DESCRIPTION
     Check if page_scan_enabled is enabled.
RETURNS
     success or failure
****************************************************************************/
bool sinkInquiryIsPageScanEnabled(void)
{
     return (GINQDATA.page_scan_enabled)?(TRUE):(FALSE);
}
/****************************************************************************
NAME
    sinkInquirySetInquiryScanEnabled

DESCRIPTION
    Set inquiry_scan_enabled.
****************************************************************************/
void sinkInquirySetInquiryScanEnabled(bool inquiry_scan_enabled)
{
     GINQDATA.inquiry_scan_enabled = inquiry_scan_enabled;
}
/****************************************************************************
NAME
    sinkInquirySetPageScanEnabled

DESCRIPTION
    Set page_scan_enabled.
****************************************************************************/
void sinkInquirySetPageScanEnabled(bool page_scan_enabled)
{
     GINQDATA.page_scan_enabled = page_scan_enabled;
}
/****************************************************************************
NAME
