...
DESCRIPTION
    Checks if ANC is in the active mode of operation

*/
#ifdef ENABLE_ANC
bool sinkAncIsModeActive(void);
#else
#define sinkAncIsModeActive() (FALSE)
#endif
...
DESCRIPTION
    Checks the next active/leakthrough mode of ANC
*/
#ifdef ENABLE_ANC
MessageId sinkAncGetNextMode(void);
#else
#define sinkAncGetNextMode() (0)
#endif
