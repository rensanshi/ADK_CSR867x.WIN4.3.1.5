...
/* LED Error ID, used to indicate possible configuration error */
#define SINK_ANC_ERR_ID 10
...
*/
static audio_mic_params getMicParams(anc_mic_selection mic)
{
...
static bool readAncMicConfigParams(anc_mic_params_t *anc_mic_params)
{
    ...
    {
    	anc_mic_selection feedForwardLeftMic = read_data->anc_mic_params_r_config.feed_forward_left_mic;
    	anc_mic_selection feedForwardRightMic = read_data->anc_mic_params_r_config.feed_forward_right_mic;
    	anc_mic_selection feedBackLeftMic = read_data->anc_mic_params_r_config.feed_back_left_mic;
    	anc_mic_selection feedBackRightMic = read_data->anc_mic_params_r_config.feed_back_right_mic;
...
static bool sinkAncStateUninitialisedHandleEvent(sink_anc_state_event_id event)
{
    ...
    switch (event)
    {
        case sink_anc_state_event_initialise:
        {
            ...
            {
                LedsIndicateError(SINK_ANC_ERR_ID);
            }
        }
        break;
