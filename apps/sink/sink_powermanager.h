...
#else
#define powerManagerPrepareForDormant() (0)
#endif
...
#else
#define powerManagerHandleEmergencyMode() (0)
#endif
...
#else
#define  powerManagerIsChargerStuck() (0)
#endif
...
#else
#define  powerManagerChargerStuckTimeout() ((void)(0))
#endif
