...
.CONST $LEFT_PASS_THRU_OBJ_FIELD    0;
.CONST $RIGHT_PASS_THRU_OBJ_FIELD   1;
.CONST $LEFT_EQ_OBJ_FIELD           2;
.CONST $RIGHT_EQ_OBJ_FIELD          3;
.CONST $EQ_OBJ_OFFSET_FIELD         ($LEFT_EQ_OBJ_FIELD - $LEFT_PASS_THRU_OBJ_FIELD);
.CONST $NUM_PASS_THRU_OBJ           2;
