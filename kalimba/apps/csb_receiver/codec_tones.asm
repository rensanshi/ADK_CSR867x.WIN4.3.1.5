...
.MODULE $codec_tones;
   ...
   // Tone data structure used in BA to play tone data after A2DP data has stopped.
   .VAR $tone_mixing_data[] = 
   ...
   .VAR $current_tone_sampling_rate = TONE_SAMPLE_RATE;                          // input tone/prompt sample rate, set by VM before tone starts
...
.MODULE $M.set_tone_rate_from_vm;
   ...
   // not used in BA, just use default setup of 0.5
