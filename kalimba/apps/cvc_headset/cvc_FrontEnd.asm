   ...
   .VAR copy_struc[] =
    ...
    .BLOCK hw_rate_op;
        ...
        .VAR hw_rate_op.param[$cbops.hw_warp_op.STRUC_SIZE] =
            ...
            ($cbops.hw_warp_op.PORT_MASK_DAC_BITMASK_INST0 << $cbops.hw_warp_op.PORT_MASK_DAC_START_POS) + $cbops.hw_warp_op.PORT_MASK_ADC_BITMASK_INST012,              // WHICH_PORTS_OFFSET
