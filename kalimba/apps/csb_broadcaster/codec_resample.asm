...
.MODULE $M.codec_resampler;
   ...
   .VAR codec_resamp_in_right_cbuffer_struc[$cbuffer.STRUC_SIZE] = 0 ...;
    ...
    .VAR resamp_out_md_track_state_l[MD_TRACK_STATE_STRUC_SIZE] =
        ...
        &$audio_out_left_cbuffer_struc,           // md_track_state.output_cbuffer
        &$eq_out_left_md_list,                    // md_track_state.input_md_list
        &$audio_out_left_md_list,                 // md_track_state.output_md_list
    ...
    .VAR resamp_out_md_track_state_r[MD_TRACK_STATE_STRUC_SIZE] =
        ...
        &$audio_out_right_cbuffer_struc,          // md_track_state.output_cbuffer
        &$eq_out_right_md_list,                   // md_track_state.input_md_list
        &$audio_out_right_md_list,                // md_track_state.output_md_list
        0,                                        // md_track_state.algorithmic_delay_samples
        0 ...;
 ...
 //     44100, 48000, $M.iir_resamplev2.Up_160_Down_147.filter,
   ...
   .VAR left[$iir_resamplev2.OBJECT_SIZE] =
      ...
      &$audio_out_left_cbuffer_struc,                              	    // $iir_resamplev2.OUTPUT_1_START_INDEX_FIELD             1;
      // Filter Definition
   ...
   .VAR right[$iir_resamplev2.OBJECT_SIZE] =
      ...
      &$audio_out_right_cbuffer_struc,                            		// $iir_resamplev2.OUTPUT_1_START_INDEX_FIELD             1;
      // Filter Definition
      0,                                                                // $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD            2;
      -8,                                                               // $iir_resamplev2.INPUT_SCALE_FIELD                      3;
      8,                                                                // $iir_resamplev2.OUTPUT_SCALE_FIELD                     4;
...
/* // removed inv rate calc, not used
   ...
   pop rLink;  */
    ...
    $push_rLink_macro;
    // configure ttp setings for new sample rate
    // TODO: consider allowing each input to have different sr
    r0 = r1;
    $call_c_with_int_return_macro(sr2srbits);
    M[$app.analogue.ttp_settings_struc + TTP_SETTINGS_SAMPLE_RATE_FIELD] = r0;
    M[$app.usb.ttp_settings_struc + TTP_SETTINGS_SAMPLE_RATE_FIELD] = r0;
    M[$app.rtp.ttp_settings_struc + TTP_SETTINGS_SAMPLE_RATE_FIELD] = r0;
    r0 = &$app.ttp_state;
