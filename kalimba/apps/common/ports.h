...
.CONST $PRIMARY_LEFT_OUT_PORT_NUMBER                            4; // ...other output channels
.CONST $PRIMARY_RIGHT_OUT_PORT_NUMBER                           5; //
.CONST $SECONDARY_LEFT_OUT_PORT_NUMBER                          6; //
.CONST $SECONDARY_RIGHT_OUT_PORT_NUMBER                         7; //
.CONST $SUB_WIRED_OUT_PORT_NUMBER                               8; // Wired subwoofer output
