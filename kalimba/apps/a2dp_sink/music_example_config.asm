...
#if uses_DH_EQ_OPTION
    #define MAX_SPKR_EQ_OBJECT_SIZE         DH_PEQ_OBJECT_SIZE(MAX_NUM_SPKR_EQ_STAGES)
    #define MAX_BOOST_EQ_OBJECT_SIZE        DH_PEQ_OBJECT_SIZE(MAX_NUM_BOOST_EQ_STAGES)
    #define MAX_ANC_EQ_OBJECT_SIZE          DH_PEQ_OBJECT_SIZE(MAX_NUM_ANC_EQ_STAGES)
    #define MAX_USER_EQ_OBJECT_SIZE         DH_PEQ_OBJECT_SIZE(MAX_NUM_USER_EQ_STAGES)
    #define MAX_XOVER_PRI_EQ_OBJECT_SIZE    DH_PEQ_OBJECT_SIZE(MAX_NUM_SPKR_CTRL_PRI_EQ_STAGES)
    #define MAX_XOVER_SEC_EQ_OBJECT_SIZE    DH_PEQ_OBJECT_SIZE(MAX_NUM_SPKR_CTRL_SEC_EQ_STAGES)
    #define MAX_XOVER_BASS_EQ_OBJECT_SIZE   DH_PEQ_OBJECT_SIZE(MAX_NUM_SPKR_CTRL_BASS_EQ_STAGES)
    #define MAX_WIRED_SUB_EQ_OBJECT_SIZE    DH_PEQ_OBJECT_SIZE(MAX_NUM_WIRED_SUB_EQ_STAGES)
#else
    #define MAX_SPKR_EQ_OBJECT_SIZE         HQ_PEQ_OBJECT_SIZE(MAX_NUM_SPKR_EQ_STAGES)
    #define MAX_BOOST_EQ_OBJECT_SIZE        HQ_PEQ_OBJECT_SIZE(MAX_NUM_BOOST_EQ_STAGES)
    #define MAX_ANC_EQ_OBJECT_SIZE          HQ_PEQ_OBJECT_SIZE(MAX_NUM_ANC_EQ_STAGES)
    #define MAX_USER_EQ_OBJECT_SIZE         HQ_PEQ_OBJECT_SIZE(MAX_NUM_USER_EQ_STAGES)
    #define MAX_XOVER_PRI_EQ_OBJECT_SIZE    HQ_PEQ_OBJECT_SIZE(MAX_NUM_SPKR_CTRL_PRI_EQ_STAGES)
    #define MAX_XOVER_SEC_EQ_OBJECT_SIZE    HQ_PEQ_OBJECT_SIZE(MAX_NUM_SPKR_CTRL_SEC_EQ_STAGES)
    #define MAX_XOVER_BASS_EQ_OBJECT_SIZE   HQ_PEQ_OBJECT_SIZE(MAX_NUM_SPKR_CTRL_BASS_EQ_STAGES)
    #define MAX_WIRED_SUB_EQ_OBJECT_SIZE    HQ_PEQ_OBJECT_SIZE(MAX_NUM_WIRED_SUB_EQ_STAGES)
#endif
#ifdef TWS_ENABLE
...
// compensated in volume module at the end of processing chain
 ...
 // Used in full processing
...
#ifdef LOWMEM_NO_RIGHT         // Data Object used to copy data from left to right with unity gain
   .VAR tws_rom_headroom_mant = 0.5;
   .VAR IntOneValue = 1;
   .VAR $left_to_right_obj[$M.audio_proc.stream_gain.STRUC_SIZE] =
      &stream_map_left_in,      // OFFSET_INPUT_PTR
      &stream_map_left_in,     // OFFSET_OUTPUT_PTR
      &tws_rom_headroom_mant,   // OFFSET_PTR_MANTISSA
      &IntOneValue;             // OFFSET_PTR_EXPONENT
   ...
   .VAR/DM2 spkr_eq_left_dm2[MAX_SPKR_EQ_OBJECT_SIZE] =
   ...
   .VAR/DM2 boost_eq_left_dm2[MAX_BOOST_EQ_OBJECT_SIZE] =
      &stream_map_left_in,              // PTR_INPUT_DATA_BUFF_FIELD
      &stream_map_left_in,              // PTR_OUTPUT_DATA_BUFF_FIELD
   ...
   .VAR/DM2 boost_eq_right_dm2[MAX_BOOST_EQ_OBJECT_SIZE] =
      &stream_map_right_in,             // PTR_INPUT_DATA_BUFF_FIELD
      &stream_map_right_in,             // PTR_OUTPUT_DATA_BUFF_FIELD
      MAX_NUM_BOOST_EQ_STAGES,          // MAX_STAGES_FIELD
      &BoostEqCoefsA,                   // PARAM_PTR_FIELD
...
#if uses_ANC_EQ
    // object for currently running Boost EQs
   .VAR/DM2 anc_eq_left_dm2[MAX_ANC_EQ_OBJECT_SIZE] =
      &stream_map_left_in,              // PTR_INPUT_DATA_BUFF_FIELD
      &stream_map_left_in,              // PTR_OUTPUT_DATA_BUFF_FIELD
      MAX_NUM_ANC_EQ_STAGES,          // MAX_STAGES_FIELD
      &AncEqCoefsA,                   // PARAM_PTR_FIELD
      0 ...;
   .VAR/DM2 anc_eq_right_dm2[MAX_ANC_EQ_OBJECT_SIZE] =
      &stream_map_right_in,             // PTR_INPUT_DATA_BUFF_FIELD
      &stream_map_right_in,             // PTR_OUTPUT_DATA_BUFF_FIELD
      MAX_NUM_ANC_EQ_STAGES,          // MAX_STAGES_FIELD
      &AncEqCoefsA,                   // PARAM_PTR_FIELD
   ...
   .VAR/DM2 user_eq_left_dm2[MAX_USER_EQ_OBJECT_SIZE] =
      &stream_map_left_in,              // PTR_INPUT_DATA_BUFF_FIELD
      &stream_map_left_in,              // PTR_OUTPUT_DATA_BUFF_FIELD
    ...
    .VAR/DM2 user_eq_right_dm2[MAX_USER_EQ_OBJECT_SIZE] =
      &stream_map_right_in,             // PTR_INPUT_DATA_BUFF_FIELD
      &stream_map_right_in,             // PTR_OUTPUT_DATA_BUFF_FIELD
      MAX_NUM_USER_EQ_STAGES,           // MAX_STAGES_FIELD
      &UserEqCoefsA,                    // PARAM_PTR_FIELD
...
#else
        0,          // INIT_BASS_EQ_DEFN_PTR
        0;         // INIT_BASS_EQ_BANK_SELECT_PTR
#endif        
    ...
    .VAR/DM2 spkr_ctrl_left_pri_eq_dm[MAX_XOVER_PRI_EQ_OBJECT_SIZE] =
    ...
    .VAR/DM2 spkr_ctrl_right_pri_eq_dm[MAX_XOVER_PRI_EQ_OBJECT_SIZE] =
    ...
    .VAR/DM2 spkr_ctrl_left_sec_eq_dm[MAX_XOVER_SEC_EQ_OBJECT_SIZE] =
    ...
    .VAR/DM2 spkr_ctrl_right_sec_eq_dm[MAX_XOVER_SEC_EQ_OBJECT_SIZE] =
    ...
    .VAR/DM2 spkr_ctrl_bass_eq_dm[MAX_XOVER_BASS_EQ_OBJECT_SIZE] =
...
.ENDBLOCK;
    ...
    .VAR/DM2 sub_eq_dm2[MAX_WIRED_SUB_EQ_OBJECT_SIZE] =
...
.BLOCK multichannel_volume_and_limit_block;
   ...
   .VAR multichannel_volume_and_limit_obj[$volume_and_limit.STRUC_SIZE] =
        0x000000,                                         //OFFSET_CONTROL_WORD_FIELD
        $M.MUSIC_MANAGER.CONFIG.VOLUME_LIMITER_BYPASS,    //OFFSET_BYPASS_BIT_FIELD
#ifdef SUB_SUPPORT_DISABLE
        4,                                                //NROF_CHANNELS_FIELD
#else
...
#if defined(SEC_CHANNEL_DISABLE)
...
#endif
#if defined(AUX_CHANNEL_DISABLE)
...
// This table must be null terminated.
   ...
   .VAR reinitialize_table[] =
    // Function                          r7                   r8
    $config_filter_defn_tables,          0,                    0, // this must be placed ahead of all peq initialize functions
#if uses_SPKR_EQ
...
#endif
#if uses_BASS_BOOST
    $music_example.peq.zerodelay,      &BoostEqDefnTable,       0,
#endif
#if uses_ANC_EQ
    $music_example.peq.zerodelay,      &AncEqDefnTable,         0,
#endif
#if uses_USER_EQ
    $music_example.peq.zerodelay,      &UserEqDefnTable,        0,
#endif
        ...
        $spkr_ctrl_system.zero_data,     &spkr_ctrl_bass_buffer, length(&spkr_ctrl_bass_buffer),
            ...
            #if uses_WIRED_SUB_EQ
                $music_example.peq.zerodelay,      &WiredSubEqDefnTable,           0,
            #endif
    #endif //SUB_SUPPORT_DISABLE        
    #endif
    0;
...
#ifdef LOWMEM_NO_RIGHT  //TWS mode does not have right out from decoder
       $M.audio_proc.stream_gain.Process.func,  &$left_to_right_obj,  0,
#endif  
        $M.audio_proc.peak_monitor.Process.func,    &pcmin_l_pk_dtct,           0,
        $M.audio_proc.peak_monitor.Process.func,    &pcmin_r_pk_dtct,           0,
...
#if uses_USER_EQ
        $music_example.peq.process,                 &UserEqDefnTable,           $M.MUSIC_MANAGER.CONFIG.USER_EQ_BYPASS,
#endif  // uses_USER_EQ

#if uses_ANC_EQ
        $music_example.anc_eq.process,              &AncEqDefnTable,            $M.MUSIC_MANAGER.CONFIG.ANC_EQ_BYPASS,

#endif
#if uses_BASS_BOOST
        $bass_boost_process_wrapper,                &BoostEqDefnTable,         0,
#endif  // uses_BASS_BOOST
...
#if uses_SPKR_EQ
        $music_example.peq.process,                 &SpkrEqDefnTable,           $M.MUSIC_MANAGER.CONFIG.SPKR_EQ_BYPASS,
#endif  // uses_SPKR_EQ
...
#ifdef WIRELESS_SUB_ENABLE
	    $M.check_apply_volume.func,                  &sub_volume_and_limit_obj,  &uses_wired_sub,  	
#endif   // WIRELESS_SUB_ENABLE
...
.MODULE $M.check_wired_subwoofer;
   .CODESEGMENT CHECK_WIRED_SUB_PM;
   ...
   r7 = $M.system_config.data.WiredSubEqDefnTable;
...
#ifdef WIRELESS_SUB_ENABLE
// input: r7 data struct ptr
//        r8 bypass flag
.MODULE $M.check_apply_volume;
...
func:
    ...
    Null = M[r8]; // uses_wired_sub as bypass flag?
	if NZ  jump done_apply_volume; 
	// apply volume  
	call $volume_and_limit.apply_volume;
...
.MODULE $M.frame_proc_stream_configure;
 .CODESEGMENT FRAME_PROC_STREAM_CONFIGURE;
 .DATASEGMENT DM;
