...
.CONST $OUTPUT_HANDLER_PERIOD_TABLE_SIZE                4;
   ...
   #define SEC_CHANNEL_DISABLE
   #define AUX_CHANNEL_DISABLE
#endif
// Specify several samples of extra space (above that required for a frame)
// for chain0 output cbuffers to ensure that a rate matched chain1 (locked to chain0)
// also has enough cbuffer output space for the frame.
.CONST $MULTI_CHAN_CHAIN0_EXTRA_SAMPLES                 10;
