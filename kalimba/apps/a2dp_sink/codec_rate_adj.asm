...
.MODULE $codec_rate_adj;
  ...
  #endif // SPDIF_ENABLE
#else   // MERGE_SPDIF_SBC
      $sra_struct + $sra.SRA_RATE_FIELD,                                      // $cbops.rate_adjustment_and_shift.Process.SRA_TARGET_RATE_ADDR_FIELD
#endif  // MERGE_SPDIF_SBC
      $cbops.dither_and_shift.DITHER_TYPE_NONE,                               // $cbops.rate_adjustment_and_shift.Process.DITHER_TYPE_FIELD
      0,
#if defined(SPDIF_ENABLE)
      $cbops.rate_adjustment_and_shift.SRA_HD_QUALITY_COEFFS_SIZE,            // $cbops.rate_adjustment_and_shift.FILTER_COEFFS_SIZE_FIELD = $cbops.rate_adjustment_and_shift.SRA_HD_QUALITY_COEFFS_SIZE
#else                                                                         
      $cbops.rate_adjustment_and_shift.SRA_COEFFS_SIZE,                       // $cbops.rate_adjustment_and_shift.FILTER_COEFFS_SIZE_FIELD = $cbops.rate_adjustment_and_shift.SRA_COEFFS_SIZE
#endif       
...
run_rate_adjustment:
   ...
   $push_rLink_macro;
    ...
    // reuse $resampler_cache.mem
    r1 = $resampler_cache.mem;
    r2 = LENGTH($sra_coeffs);
    r3 = M[$codec_rate_adj.stereo + $cbops.rate_adjustment_and_shift.Process.FILTER_COEFFS_FIELD];
    Null = r3 - $sra_coeffs;
    if  Z   jump tws_cache_coeff;
    r2 = LENGTH($sra_coeffs_hd_quality);
tws_cache_coeff:    
    call  $tws.copy_array;
    M[$codec_rate_adj.stereo + $cbops.rate_adjustment_and_shift.Process.FILTER_COEFFS_FIELD] = r1;
    push r3;   
    ...
    // restore sra_coeffs
    pop r3;    
    M[$codec_rate_adj.stereo + $cbops.rate_adjustment_and_shift.Process.FILTER_COEFFS_FIELD] = r3;
...
// efuse as part of features
#ifdef EFUSE
    r2 = M[$M.KapLoader.FlashFileSystem.OTP_ram_data];
    Null = r2 and EFUSE_SRC_MASK;
    if   Z   rts;    
#endif  // EFUSE
