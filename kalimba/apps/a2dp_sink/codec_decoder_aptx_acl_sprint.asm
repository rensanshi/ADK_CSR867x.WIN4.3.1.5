...
#ifdef   USE_PACKED_ENCODED_DATA
   .VAR initial_write_bytepos = $packed_cbuffer.INIT_BYTEPOS;
#endif // USE_PACKED_ENCODED_DATA
...
#ifdef   USE_PACKED_ENCODED_DATA
   r0 = M[&$codec_in_cbuffer_struc + $packed_cbuffer.WRITE_BYTEPOS_FIELD];
   M[initial_write_bytepos] = r0;
#endif  // USE_PACKED_ENCODED_DATA
...
L0 = 0;
   ...
   // packed cbuffer update
   r0 = M[&$codec_in_cbuffer_struc + $cbuffer.WRITE_ADDR_FIELD];
   r0 = r0 - M[initial_write_pos];
#ifdef   USE_PACKED_ENCODED_DATA
   r1 = M[initial_write_bytepos];
   r1 = r1 - M[&$codec_in_cbuffer_struc + $packed_cbuffer.WRITE_BYTEPOS_FIELD];
   r0 = r0 * 3 (int);
   r0 = r0 + r1;
   r0 = r0 ASHIFT -1;  // byte to word conversion
#endif   // USE_PACKED_ENCODED_DATA
