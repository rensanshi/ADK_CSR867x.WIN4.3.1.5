...
.MODULE $codec_tones;
...
#else 
   DeclareCBufferNoMem($tone_in_right_resample_cbuffer_struc,$tone_in_left_resample);
#endif 
...
#else 
   DeclareCBufferNoMem($tone0_in_right_resample_cbuffer_struc,$tone_in_left_resample);
   DeclareCBufferNoMem($tone1_in_right_resample_cbuffer_struc,$tone_in_left_resample);
   DeclareCBufferNoMem($tone2_in_right_resample_cbuffer_struc,$tone_in_left_resample);
#endif 
...
#else 
      .VAR $mono_tone_in_left_resample_op.next = $tone_in_resample_complete_op;
#endif 
...
#else 
      .VAR $stereo_tone_in_copy_op.next = $stereo_tone_down_mix;
#endif 
   ...
   .BLOCK $stereo_tone_down_mix;
      .VAR $stereo_tone_down_mix.next = $cbops.NO_MORE_OPERATORS;
      .VAR $stereo_tone_down_mix.func = &$cbops.two_to_one_chan_copy;
      .VAR $stereo_tone_down_mix.param[$cbops.two_to_one_chan_copy.STRUC_SIZE] =
            1,                            // Input index (left)
            2,                            // Input index (right)
            1,                            // Output index
            0.5,                          // Left gain
   ...
   .BLOCK $tone_in_right_resample_op;
      ...
      .VAR $tone_in_right_resample_op.param[$cbops.fir_resample.STRUC_SIZE] =
         ...
         0 ...;
   .ENDBLOCK;
#endif ///#ifndef DOWNMIX_STEREO_TONE
...
//  cache sra_coeffs  ptr  
#ifdef USE_SRA_COEFF_CACHE

    // cache sra_coeffs
    r1 = $sra_cache.mem;
    r2 = LENGTH($sra_coeffs);
    r3 = $sra_coeffs;
    call  $tws.copy_array;

#ifndef DOWNMIX_STEREO_TONE
    M[$tone_in_left_resample_op.param  + $cbops.fir_resample.COEF_BUF_INDEX_FIELD] = r1;
    M[$tone_in_right_resample_op.param + $cbops.fir_resample.COEF_BUF_INDEX_FIELD] = r1;
#else 
    M[$mono_tone_in_left_resample_op.param  + $cbops.fir_resample.COEF_BUF_INDEX_FIELD] = r1;
#endif 

stereo_tone_resampler:
...
//  restore sra_coeffs    ptr
#ifdef  USE_SRA_COEFF_CACHE

    r3 = $sra_coeffs;
#ifndef DOWNMIX_STEREO_TONE
    M[$tone_in_left_resample_op.param  + $cbops.fir_resample.COEF_BUF_INDEX_FIELD] = r3;
    M[$tone_in_right_resample_op.param + $cbops.fir_resample.COEF_BUF_INDEX_FIELD] = r3;
#else  // DOWNMIX_STEREO_TONE
    M[$mono_tone_in_left_resample_op.param  + $cbops.fir_resample.COEF_BUF_INDEX_FIELD] = r3;
#endif //  DOWNMIX_STEREO_TONE
stereo_tone_done:
#endif  // USE_SRA_COEFF_CACHE
...
//  cache sra_coeffs  ptr    
    ...
    M[$mono_tone_in_left_resample_op.param  + $cbops.fir_resample.COEF_BUF_INDEX_FIELD] = r1;
#ifndef DOWNMIX_STEREO_TONE
    M[$mono_tone_in_right_resample_op.param + $cbops.fir_resample.COEF_BUF_INDEX_FIELD] = r1;
#endif //  DOWNMIX_STEREO_TONE
mono_tone_resampler:
#endif  //  USE_SRA_COEFF_CACHE
...
//  restore sra_coeffs    ptr  
    ...
    M[$mono_tone_in_left_resample_op.param  + $cbops.fir_resample.COEF_BUF_INDEX_FIELD] = r3;
#ifndef DOWNMIX_STEREO_TONE
    M[$mono_tone_in_right_resample_op.param + $cbops.fir_resample.COEF_BUF_INDEX_FIELD] = r3;
#endif //  DOWNMIX_STEREO_TONE
mono_tone_done:
#endif  //  USE_SRA_COEFF_CACHE
