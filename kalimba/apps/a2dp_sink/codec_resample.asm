...
.MODULE $codec_resampler;
 ...
 // TBD: codec_resamp_out overlay scheme, start address multiple of 512 
#if defined(AAC_ENABLE) && defined(AAC_RIGHT_MEM_OVERLAY)
#define  CODEC_RESAMP_OUT_CBUFFER_START_OFFSET_ROUNDUP_TO_2POWERN  2048    
   .VAR $codec_resamp_out_right_cbuffer_struc[$cbuffer.STRUC_SIZE]           =  CODEC_RESAMPLER_CBUFFER_SIZE,
                                                                                $M.tws.delay_buf_left + CODEC_RESAMP_OUT_CBUFFER_START_OFFSET_ROUNDUP_TO_2POWERN,
                                                                                $M.tws.delay_buf_left + CODEC_RESAMP_OUT_CBUFFER_START_OFFSET_ROUNDUP_TO_2POWERN;
   .VAR $codec_resamp_out_right_cbuffer_struc_template[$cbuffer.STRUC_SIZE]  =  CODEC_RESAMPLER_CBUFFER_SIZE,
                                                                                $M.tws.delay_buf_left + CODEC_RESAMP_OUT_CBUFFER_START_OFFSET_ROUNDUP_TO_2POWERN,
                                                                                $M.tws.delay_buf_left + CODEC_RESAMP_OUT_CBUFFER_START_OFFSET_ROUNDUP_TO_2POWERN;
#else    // AAC_RIGHT_MEM_OVERLAY       
...
run_resampler:
   ...
   if NEG jump resample_no_TWS;
    ...
    pushm <r7, r8, r9>;
    // cache left channel
   r7 = M[$codec_resampler.left + $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD];
   r8 = &$resampler_cache.mem;
   call $resampler_cache.Func;
   
   M[$codec_resampler.left + $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD] = r9;
   pushm <r7,r9>;
   ...
   r0 = M[$app_config.io];
   Null = r0 - $AAC_IO;
   if NZ jump resample_right; 
      //No audio_out_right_buffer available
           
#ifdef USE_IIR_RESAMPLER_COEFF_CACHE
      // restore left channel setup
      popm <r7,r9>;
      M[$codec_resampler.left + $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD] = r7;
      popm <r7, r8, r9>;
#endif // USE_IIR_RESAMPLER_COEFF_CACHE
...
// cache right channel
   ...
   M[$codec_resampler.left + $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD] = r7;
    // cache right channel
   r8 = M[$codec_resampler.right + $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD];
   Null = r7 - r8;  // same filter for left & right channel
   if  Z  jump bypass_tws_cache_right_channel;
   r7 = r8;
   r8 = &$resampler_cache.mem;
   call $resampler_cache.Func;
bypass_tws_cache_right_channel:
   M[$codec_resampler.right + $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD] = r9;
   pushm <r7,r9>;
   ...
   // restore right channel setup
   popm <r7,r9>;
   M[$codec_resampler.right + $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD] = r7;
   popm <r7, r8, r9>;
   ...
   r8 = M[$codec_resampler.right + $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD];
   Null = r7 - r8;  // same filter for left & right channel
   if  Z  jump bypass_cache_right_channel;
   r7 = r8;
   r8 = &$resampler_cache.mem;
   call $resampler_cache.Func;
bypass_cache_right_channel:
   M[$codec_resampler.right + $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD] = r9;
   pushm <r7,r9>;
