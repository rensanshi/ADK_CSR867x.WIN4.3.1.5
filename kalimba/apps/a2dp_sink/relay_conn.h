...
.CONST  $TWS_ALIGNMENT_DELAY                             11700;//
#else 
...
#ifdef A2DP_SINK_LOWMEM
#define $TWS_SLAVE_SRA_TC                180000
#define $TWS_MASTER_DELAY_TIME           250000
#define $TWS_STALL_TIME                  180000
#define $TWS_STALL_TO_DECODE_THRESHOLD   200000
#else
