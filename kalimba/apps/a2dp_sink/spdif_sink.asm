...
.VAR $mp3_stats[8] =
   ...
   .VAR $encoded_latency_struct[$encoded_latency.STRUC_SIZE] =
    ...
    .VAR cbuffers_latency_measure[] =
       ...
       $codec_rate_adj_out_left_cbuffer_struc, $intermediate_fs_1, 0,
       $multi_chan_primary_left_out_cbuffer_struc, $intermediate_fs_1, 0,
       $MULTI_CHAN_PRIMARY_LEFT_OUT_PORT, $intermediate_fs_1, 0,
       0;
