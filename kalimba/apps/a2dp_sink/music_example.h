...
.CONST $music_example.FDT_LIST_COUNT                        8;
.CONST $music_example.FDT_CONFIG_BITS                       2;
.CONST $music_example.BIQUAD_FUNC_INIT                      0;
.CONST $music_example.BIQUAD_FUNC_ZERODEL                   1;
.CONST $music_example.BIQUAD_FUNC_PROC                      2;
.CONST $music_example.BIQUAD_FUNC_PROC_OP                   3;
