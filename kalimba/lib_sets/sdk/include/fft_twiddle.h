...
// Work out the maximum FFT twiddle size
#if (defined(FFT_TWIDDLE_NEED_2048_POINT))
#define FFT_TWIDDLE_SIZE 2048
#elif (defined(FFT_TWIDDLE_NEED_1024_POINT))
#define FFT_TWIDDLE_SIZE 1024
#elif (defined(FFT_TWIDDLE_NEED_512_POINT))
#define FFT_TWIDDLE_SIZE 512
#elif (defined(FFT_TWIDDLE_NEED_256_POINT))
#define FFT_TWIDDLE_SIZE 256
#elif (defined(FFT_TWIDDLE_NEED_128_POINT))
#define FFT_TWIDDLE_SIZE 128
#elif (defined(FFT_TWIDDLE_NEED_64_POINT))
#define FFT_TWIDDLE_SIZE 64
#elif (defined(FFT_TWIDDLE_NEED_32_POINT))
#define FFT_TWIDDLE_SIZE 32
#elif (defined(FFT_TWIDDLE_NEED_16_POINT))
#define FFT_TWIDDLE_SIZE 16
#elif (defined(FFT_TWIDDLE_NEED_8_POINT))
#define FFT_TWIDDLE_SIZE 8
#endif

#if (! defined(FFT_TWIDDLE_INCLUDED) && defined(FFT_TWIDDLE_SIZE))
   ...
   .DATASEGMENT DM;
      ...
      // twiddle factors needed for <= 2048 point fft and ifft routines
         ...
         .VAR/DM_IMAG_TWIDDLE $fft.twiddle_imag[1024] =
            ...
            -0.0030679568;
      #endif // FFT_LOW_RAM
   #else // FFT_TWIDDLE_SIZE_2048_POINT
   #if (FFT_TWIDDLE_SIZE == 1024)
         ...
         .VAR/DM_IMAG_TWIDDLE $fft.twiddle_imag[512] =
            ...
            -0.0061358846;
      #endif // FFT_LOW_RAM
   #else // FFT_TWIDDLE_SIZE_1024_POINT
   #if (FFT_TWIDDLE_SIZE == 512)
         ...
         .VAR/DM_IMAG_TWIDDLE $fft.twiddle_imag[256] =
            ...
            -0.0122715383;
      #endif // FFT_LOW_RAM
   #else // FFT_TWIDDLE_SIZE_512_POINT
   #if (FFT_TWIDDLE_SIZE == 256)
      #if defined(FFT_LOW_RAM)
         ...
         .VAR/DM_IMAG_TWIDDLE $fft.twiddle_imag[128] =
            ...
            -0.0245412285;
      #endif // FFT_LOW_RAM
   #else // FFT_TWIDDLE_SIZE_256_POINT
   #if (FFT_TWIDDLE_SIZE == 128)
      #if defined(FFT_LOW_RAM)
         ...
         .VAR/DM_IMAG_TWIDDLE $fft.twiddle_imag[64] =
            ...
            -0.0490676743;
      #endif // FFT_LOW_RAM
   #else // FFT_TWIDDLE_SIZE_128_POINT
   #if (FFT_TWIDDLE_SIZE == 64)
      #if defined(FFT_LOW_RAM)
         ...
         .VAR/DM_IMAG_TWIDDLE $fft.twiddle_imag[32] =
            ...
            -0.0980171403;
      #endif // FFT_LOW_RAM
   #else // FFT_TWIDDLE_SIZE_64_POINT
   #if (FFT_TWIDDLE_SIZE == 32)
      #if defined(FFT_LOW_RAM)
         ...
         .VAR/DM_IMAG_TWIDDLE $fft.twiddle_imag[16] =
            ...
            -0.1950903220;
      #endif
   #else // FFT_TWIDDLE_SIZE_32_POINT
   #if (FFT_TWIDDLE_SIZE == 16)
      #if defined(FFT_LOW_RAM)
         ...
         .VAR/DM_IMAG_TWIDDLE $fft.twiddle_imag[8] =
            ...
            -0.3826834324;
      #endif // FFT_LOW_RAM
   #else // FFT_TWIDDLE_SIZE_16_POINT
   #if (FFT_TWIDDLE_SIZE == 8)
      #if defined(FFT_LOW_RAM)
         ...
         .VAR/DM_IMAG_TWIDDLE $fft.twiddle_imag[4] =
            ...
            -0.7071067812;
      #endif // FFT_LOW_RAM
   #else // FFT_TWIDDLE_SIZE_8_POINT

      // if FFT_TWIDDLE_SIZE_xxx_POINT is not defined then we don't define any twiddle factors

   #endif // FFT_TWIDDLE_SIZE_8_POINT
   #endif // FFT_TWIDDLE_SIZE_16_POINT
   #endif // FFT_TWIDDLE_SIZE_32_POINT
   #endif // FFT_TWIDDLE_SIZE_64_POINT
   #endif // FFT_TWIDDLE_SIZE_128_POINT
   #endif // FFT_TWIDDLE_SIZE_256_POINT
   #endif // FFT_TWIDDLE_SIZE_512_POINT
   #endif // FFT_TWIDDLE_SIZE_1024_POINT
   #endif // FFT_TWIDDLE_SIZE_2048_POINT
