...
#define CBOPS_RATE_ADJUSTMENT_AND_SHIFT_HEADER_INCLUDED
   ...
   .CONST   $cbops.rate_adjustment_and_shift.DISABLE_RATE_FITLERING_FIELD         $cbops.rate_adjustment_and_shift.AMOUNT_USED_FIELD+1;  // current rate
   .CONST   $cbops.rate_adjustment_and_shift.STRUC_SIZE $cbops.rate_adjustment_and_shift.DISABLE_RATE_FITLERING_FIELD + 1;
