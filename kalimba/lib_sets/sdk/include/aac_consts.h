...
#define AAC_CONSTS_HEADER_INCLUDED
    ...
    .CONST $aacdec.ext.FRAME_MEM_POOL_PTR_FIELD                         0;    
    .CONST $aacdec.ext.TMP_MEM_POOL_PTR_FIELD                           1;    
    .CONST $aacdec.ext.BUF_LEFT_PTR_FIELD                               2; 
    .CONST $aacdec.ext.BUF_RIGHT_PTR_FIELD                              3;   
    .CONST $aacdec.ext.OVERLAP_BUF_LEFT_PTR_FIELD                       4;  
    .CONST $aacdec.ext.OVERLAP_BUF_RIGHT_PTR_FIELD                      5;   
    .CONST $aacdec.ext.ROUTING_MODE_FIELD                               6;   
    #endif 
    ...
    // TNS structure
    .CONST $aacdec.tns.N_FILT_FIELD                         0;    // size 8                           stored in an indexed way
    .CONST $aacdec.tns.COEF_RES_FIELD                       8;    // size 8   (1x3 long, 8x1 short)   stored in an indexed way x[2] is always for the 3rd filter
    .CONST $aacdec.tns.LENGTH_FIELD                         16;   // size 8   (1x3 long, 8x1 short)   index incremented only if filter exists
    .CONST $aacdec.tns.ORDER_FIELD                          24;   // size 8   (1x3 long, 8x1 short)   index incremented only if filter exists
    .CONST $aacdec.tns.DIRECTION_FIELD                      32;   // size 8   (1x3 long, 8x1 short)   index incremented only if filter exists
    .CONST $aacdec.tns.COEF_COMPRESS_FIELD                  40;   // size 8   (1x3 long, 8x1 short)   index incremented only if filter exists
    .CONST $aacdec.tns.COEF_FIELD                           48;   // size 56  (1x3x12 long, 8x1x7 short) index incremented only if filter exists
    ...
    .CONST $aacdec.ltp.LAG_FIELD                            0;
    .CONST $aacdec.ltp.COEF_FIELD                           1;
    .CONST $aacdec.ltp.LONG_USED_FIELD                      2;
    .CONST $aacdec.ltp.STRUC_SIZE                           $aacdec.ltp.LONG_USED_FIELD + $aacdec.LTP_MAX_SFB_LONG;

    .CONST $aacdec.mdct.NUM_POINTS_FIELD                    0;
    .CONST $aacdec.mdct.FFT_REAL_ADDR_FIELD                 1;
    .CONST $aacdec.mdct.FFT_IMAG_ADDR_FIELD                 2;
    .CONST $aacdec.mdct.INPUT_ADDR_FIELD                    3;
    .CONST $aacdec.mdct.INPUT_ADDR_BR_FIELD                 4;
    ...
    .CONST $aacdec.imdct.NUM_POINTS_FIELD                   0;
    .CONST $aacdec.imdct.INPUT_ADDR_FIELD                   1;
    .CONST $aacdec.imdct.OUTPUT_ADDR_FIELD                  2;
    .CONST $aacdec.imdct.INPUT_ADDR_BR_FIELD                3;
    .CONST $aacdec.imdct.OUTPUT_ADDR_BR_FIELD               4;
    ...
    // ICS fields
    .CONST $aacdec.ics.MAX_SFB_FIELD                        0;
    .CONST $aacdec.ics.NUM_SWB_FIELD                        1;
    .CONST $aacdec.ics.NUM_WINDOW_GROUPS_FIELD              2;
    .CONST $aacdec.ics.NUM_WINDOWS_FIELD                    3;
    .CONST $aacdec.ics.WINDOW_SEQUENCE_FIELD                4;
    .CONST $aacdec.ics.WINDOW_GROUP_LENGTH_FIELD            5;    // size 8
    .CONST $aacdec.ics.WINDOW_SHAPE_FIELD                   13;
    .CONST $aacdec.ics.SCALE_FACTOR_GROUPING_FIELD          14;
    .CONST $aacdec.ics.SWB_OFFSET_PTR_FIELD                 15;
    .CONST $aacdec.ics.SECT_SFB_OFFSET_PTR_FIELD            16;
    .CONST $aacdec.ics.NUM_SEC_FIELD                        17;   // size 8
    .CONST $aacdec.ics.SECT_CB_PTR_FIELD                    25;
    .CONST $aacdec.ics.SECT_START_PTR_FIELD                 26;
    .CONST $aacdec.ics.SECT_END_PTR_FIELD                   27;
    .CONST $aacdec.ics.SFB_CB_PTR_FIELD                     28;
    .CONST $aacdec.ics.GLOBAL_GAIN_FIELD                    29;
    .CONST $aacdec.ics.SCALEFACTORS_PTR_FIELD               30;
    .CONST $aacdec.ics.MS_MASK_PRESENT_FIELD                31;
    .CONST $aacdec.ics.MS_USED_PTR_FIELD                    32;
    .CONST $aacdec.ics.NOISE_USED_FIELD                     33;
    .CONST $aacdec.ics.PULSE_DATA_PTR_FIELD                 34;
    .CONST $aacdec.ics.TNS_DATA_PTR_FIELD                   35;
    .CONST $aacdec.ics.PREDICTOR_DATA_PRESENT_FIELD         36;
    .CONST $aacdec.ics.LTP_INFO_PTR_FIELD                   37;
    .CONST $aacdec.ics.LTP_INFO_CH2_PTR_FIELD               38;
    .CONST $aacdec.ics.TNS_ENCODE_DONE_FIELD                39;
    .CONST $aacdec.ics.TNS_N_FILT_TEMP_FIELD                40;
    .CONST $aacdec.ics.PREV_WINDOW_SEQ_EQ_LONG_START_FIELD  41;
    .CONST $aacdec.ics.STRUC_SIZE                           42;

    .CONST $aacdec.pulse.NUMBER_PULSE_FIELD                 0;
    .CONST $aacdec.pulse.PULSE_START_SFB_FIELD              1;
    .CONST $aacdec.pulse.PULSE_OFFSET_FIELD                 2;    // size 5
    .CONST $aacdec.pulse.PULSE_AMP_FIELD                    7;    // size 5
