...
.MODULE $M.cbops.limited_amount.amount_to_use;
   ...
   push rLink;
   // r5 = min(data in packed input buffer, amount space in output)
   r0 = M[r8 + $cbops.limited_amount.PACKED_CBUFFER_FIELD];
   call $packed_cbuffer.calc_amount_data_word16; // 16-bit words
   r0 = min r7;
   r5 = r0;
   pop rLink;
#endif
