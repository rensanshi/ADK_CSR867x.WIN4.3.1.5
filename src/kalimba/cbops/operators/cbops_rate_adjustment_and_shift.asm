...
.MODULE $M.cbops.rate_adjustment_and_shift.main;
   ...
   r0 = M[r8 + $cbops.rate_adjustment_and_shift.DISABLE_RATE_FITLERING_FIELD];
   if NZ jump sra_rate_filtering_complete;
