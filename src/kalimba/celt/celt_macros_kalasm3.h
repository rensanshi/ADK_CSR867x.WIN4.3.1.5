...
//
// *****************************************************************************
#ifndef CELT_MACROS_KALASM3_HEADER_INCLUDED
#define CELT_MACROS_KALASM3_HEADER_INCLUDED
 ...
 /* ----------------------------------------------------------
   ...
   result:
      RO = ceil(log2(RI))
-----------------------------------------------------------*/
.macro $celt.EC_ILOG32 RI0 RI1 RO
        rMAC = \RI1;
        rMAC0 = \RI0;
        \RO = signdet rMAC;
        \RO = 47 - \RO;
...
-----------------------------------------------------------*/
.macro $celt.get_pulses RIO RH LBL
        \RH = \RIO LSHIFT -3;
        if Z jump \LBL;
        \RH = \RH - 1;
        \RIO = \RIO AND 7;
...
/*-----------------------------------------------------------
   ...
   register trashed: RH
--------------------------------------------------------------*/
.macro $celt.fits_in32 RN RK RH LBL1 LBL2
        NULL = \RN - 14;
        if NEG jump \LBL1;
           \RH = NULL;
           NULL = \RK - 14;
...
/*------------------------------------------
   ...
   trashed: rMAC
--------------------------------------------*/
.macro $celt.ncwrs3 RK RO1 RO2 LBL
        \RO1 = 1;
        \RO2 = 0;
        rMAC = \RK;
        if Z jump \LBL;
...
/*---------------------------------------------
   ...
   trashed: rMAC, RH
----------------------------------------------*/
.macro $celt.ncwrs4 RK RO1 RO2 RH LBL
        \RO1 = 1;
        \RO2 = 0;
        \RH = 1.0/3.0;
        rMAC = \RK*4(int);
...
/*------------------------------------------------
   ...
   trashed: rMAC, RH
--------------------------------------------------*/
.macro $celt.ncwrs5 RK RO1 RO2 RH LBL
        \RO1 = 1;
        \RO2 = 0;
        \RH = 1.0/3.0;
        rMAC = \RK*\RK(int);
...
/*-------------------------------------
   macro: ucwrs3
   return k?(2*k-2)*k+1:0;
   input: RK
   output: RO2:ROI, 32-bit unsigned
   trashed: rMAC
---------------------------------------*/
.macro $celt.ucwrs3 RK RO0 RO1 LBL
        \RO0 = 0;
        \RO1 = 0;
        rMAC = \RK - 1;
        if NEG jump \LBL;
...
/*--------------------------------------------
   ...
   trashed: rMAC, RH
----------------------------------------------*/
.macro $celt.ucwrs4 RK RO1 RO2 RH LBL
        \RO2 = 0;
        \RO1 = \RK;
        if Z jump \LBL;
        \RH = 1.0/3.0;
...
/*----------------------------------------------
   ...
   trashed: rMAC, RH
----------------------------------------------*/
.macro $celt.ucwrs5 RK RO1 RO2 RH LBL
        \RO2 = 0;
        \RO1 = \RK;
        if Z jump \LBL;
        \RH = 1.0/3.0;
