...
.MODULE $M.sbcdec.frame_decode;
   ...
   buffer_underflow_1:
      ...
      jump exit;
   sync_error:
      r5 = M[r9 + $sbc.mem.FRAME_SYNC_SEARCH_DISABLE];
      if Z jump buffer_underflow;
	  
      // indicate that sync byte was not found
      r5 = M[$sbcdec.codec_struc];
      r0 = $codec.SYNC_ERROR;
      jump buffer_underflow_1;
   no_buffer_underflow:
