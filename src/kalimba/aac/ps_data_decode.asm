...
.MODULE $M.aacdec.ps_data_decode;
   ...
   if Z jump ps_num_env_eq_zero;
      ...
      iid_icc_delta_decode_outer_loop:
         ...
         if Z jump initialise_icc_delta_decode;
            ...
            r5 = M[$aacdec.ps_info + $aacdec.PS_IID_MODE];
            // else fine resolution IID delta decoding for all envelopes
            Null = r5 - 3;
            if GE r6 = M1;
            r7 = -r6;
            r3 = M[$aacdec.ps_info + $aacdec.PS_NR_IID_PAR];
            r4 = M[$aacdec.ps_info + $aacdec.PS_ENABLE_IID];
            // I4 <- PS_IID_INDEX[0][0]
            I4 = &$aacdec.ps_info + $aacdec.PS_IID_INDEX;
            // I1 <- PS_IID_INDEX_PREV : last envelope of the previous frame
            I1 = &$aacdec.ps_iid_index_prev;
         ...
         initialise_icc_delta_decode:
            ...
            r3 = M[$aacdec.ps_info + $aacdec.PS_NR_ICC_PAR];
            r4 = M[$aacdec.ps_info + $aacdec.PS_ENABLE_ICC];
            r5 = M[$aacdec.ps_info + $aacdec.PS_ICC_MODE];
            // I4 <- PS_ICC_INDEX[0][0]
            I4 = &$aacdec.ps_info + $aacdec.PS_ICC_INDEX;
            // I1 <- PS_ICC_INDEX_PREV : last envelope of the previous frame
            I1 = &$aacdec.ps_icc_index_prev;
         ...
         iid_icc_enabled_delta_decode_outer_loop:
            ...
            if Z jump read_icc_coding_direction;
               r5 = M[($aacdec.ps_info + $aacdec.PS_IID_CODING_DIRECTION) + r2];
               jump end_if_iid_or_icc_coding_direction;
            read_icc_coding_direction:
               r5 = M[($aacdec.ps_info + $aacdec.PS_ICC_CODING_DIRECTION) + r2];
            ...
            if NZ jump end_if_disabled_iid_or_icc_stride_eq_two;
               I5 = I4 + ($aacdec.PS_MIN_NUM_PARAMETERS*2 - 1);
               I1 = I4 + ($aacdec.PS_MIN_NUM_PARAMETERS - 1);
            ...
            I4 = I4 + $aacdec.PS_MAX_NUM_PARAMETERS;

         r2 = r2 + 1;
         Null = r2 - M[$aacdec.ps_info + $aacdec.PS_NUM_ENV];
   ...
   ps_num_env_eq_zero:
      ...
      r0 = 1;
      M[$aacdec.ps_info + $aacdec.PS_NUM_ENV] = r0;
      ...
      iid_or_icc_ps_num_env_eq_zero_outer_loop:
         if Z jump initialise_icc_first_envelope_loop;
            // I5 <- PS_IID_INDEX[0][0]
            I5 = &$aacdec.ps_info + $aacdec.PS_IID_INDEX;
            // I1 <- PS_IID_INDEX_PREV : last envelope of the previous frame
            I1 = &$aacdec.ps_iid_index_prev;
            r4 = M[$aacdec.ps_info + $aacdec.PS_ENABLE_IID];
         ...
         initialise_icc_first_envelope_loop:
            // I5 <- PS_ICC_INDEX[0][0]
            I5 = &$aacdec.ps_info + $aacdec.PS_ICC_INDEX;
            // I1 <- PS_ICC_INDEX_PREV : last envelope of the previous frame
            I1 = &$aacdec.ps_icc_index_prev;
            r4 = M[$aacdec.ps_info + $aacdec.PS_ENABLE_ICC];
   ...
   I4 = &$aacdec.ps_iid_index_prev;
   I5 = &$aacdec.ps_icc_index_prev;

   r0 = M[$aacdec.ps_info + $aacdec.PS_NUM_ENV];
   r0 = r0 * ($aacdec.PS_MAX_NUM_PARAMETERS) (int);
   // I1 <- PS_IID_INDEX[envelope=PS_NUM_ENV-1][0]
   I1 = (&$aacdec.ps_info + $aacdec.PS_IID_INDEX - $aacdec.PS_MAX_NUM_PARAMETERS) + r0;
   // I2 <- PS_ICC_INDEX[envelope=PS_NUM_ENV-1][0]
   I2 = (&$aacdec.ps_info + $aacdec.PS_ICC_INDEX - $aacdec.PS_MAX_NUM_PARAMETERS) + r0;
   ...
   M[$aacdec.ps_info + $aacdec.PS_BORDER_POSITION] = Null;

   M0 = 16;
   // if(PS_FRAME_CLASS == 0)
   Null = M[$aacdec.ps_info + $aacdec.PS_FRAME_CLASS];
   if NZ jump ps_frame_class_not_zero;
      ...
      do uniformly_spaced_env_borders_loop;
         M[($aacdec.ps_info + $aacdec.PS_BORDER_POSITION) + r10] = r2;
         r2 = r2 - r1;
   ...
   ps_frame_class_not_zero:
      ...
      r1 = M[($aacdec.ps_info + $aacdec.PS_BORDER_POSITION) + r0];
      ...
      if POS jump end_if_need_to_add_extra_envelope;
         ...
         M[($aacdec.ps_info + $aacdec.PS_BORDER_POSITION) + r0] = r1;

         r10 = $aacdec.PS_MAX_NUM_PARAMETERS;
         r1 = r0 * ($aacdec.PS_MAX_NUM_PARAMETERS) (int);
         I4 = (&$aacdec.ps_info + $aacdec.PS_IID_INDEX) + r1;
         I5 = (&$aacdec.ps_info + $aacdec.PS_ICC_INDEX) + r1;
         I1 = (&$aacdec.ps_info + $aacdec.PS_IID_INDEX - $aacdec.PS_MAX_NUM_PARAMETERS) + r1;
         I2 = (&$aacdec.ps_info + $aacdec.PS_ICC_INDEX - $aacdec.PS_MAX_NUM_PARAMETERS) + r1;
      ...
      I1 = (&$aacdec.ps_info + $aacdec.PS_BORDER_POSITION + 1);
      ...
      I1 = (&$aacdec.ps_info + $aacdec.PS_BORDER_POSITION);
      r2 = 1;
   ...
   r0 = M[$aacdec.ps_info + $aacdec.PS_IID_MODE];
   M0 = r0;
   r0 = M[$aacdec.ps_info +  $aacdec.PS_ICC_MODE];
   M1 = r0;

   // for envelope=0:PS_NUM_ENV-1,
   r10 = M[$aacdec.ps_info + $aacdec.PS_NUM_ENV];
   // r4 = envelope
   r4 = 0;
