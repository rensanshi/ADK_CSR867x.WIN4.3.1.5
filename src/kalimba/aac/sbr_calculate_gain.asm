...
.MODULE $M.aacdec.sbr_calculate_gain;
   ...
   M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_t_noise_band] = Null;


   r0 = M[$aacdec.sbr_info + $aacdec.SBR_bs_limiter_bands];
   r1 = M[$aacdec.sbr_info + $aacdec.SBR_Nlow];
   r1 = r1 + 5;
   r0 = r0 * r1 (int);
   r1 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_F_table_lim_base_ptr];
   r0 = r0 + r1;
   // r1 = SBR_N_L[SBR_bs_limiter_bands]
   r1 = M[$aacdec.sbr_info + $aacdec.SBR_bs_limiter_bands];
   r1 = M[($aacdec.tmp_mem_pool + $aacdec.SBR_N_L) + r1];
   // r0 = SBR_F_table_lim[SBR_bs_limiter_bands][SBR_N_L[SBR_bs_limiter_bands]]
   r3 = M[r0 + r1];

   M[$aacdec.tmp + $aacdec.SBR_calc_gain_boost_data_per_envelope] = r3;
   ...
   M[$aacdec.tmp_mem_pool + $aacdec.SBR_G_lim_boost_mantissa_ptr] = r1;

   // allocate space in temporary memory for SBR_Q_M_lim_boost_mantissa[][]
   call $aacdec.frame_mem_pool_allocate;
   M[$aacdec.tmp_mem_pool + $aacdec.SBR_Q_M_lim_boost_mantissa_ptr] = r1;

   // allocate space in temporary memory for SBR_S_M_boost_mantissa[][]
   call $aacdec.frame_mem_pool_allocate;
   M[$aacdec.tmp_mem_pool + $aacdec.SBR_S_M_boost_mantissa_ptr] = r1;

   r0 = r3;

   // allocate space in temporary memory for SBR_G_lim_boost_exponent[]
   call $aacdec.frame_mem_pool_allocate;
   M[$aacdec.tmp_mem_pool + $aacdec.SBR_G_lim_boost_exponent_ptr] = r1;

   // allocate space in temporary memory for SBR_Q_M_lim_boost_exponent[]
   call $aacdec.frame_mem_pool_allocate;
   M[$aacdec.tmp_mem_pool + $aacdec.SBR_Q_M_lim_boost_exponent_ptr] = r1;

   // allocate space in temporary memory for SBR_S_M_boost_exponent[]
   call $aacdec.frame_mem_pool_allocate;
   if NEG jump $aacdec.corruption;
   M[$aacdec.tmp_mem_pool + $aacdec.SBR_S_M_boost_exponent_ptr] = r1;
   ...
   r1 = r1 + 5;
   r0 = r0 * r1 (int);
   r0 = r0 + M[$aacdec.tmp_mem_pool + $aacdec.SBR_F_table_lim_base_ptr];
   M[$aacdec.tmp + $aacdec.SBR_calc_gain_ftable_lim_last_band_ptr] = r0;
   ...
   outer_envelope_loop:
      ...
      r0 = -(1<<15);
      M[($aacdec.sbr_info + $aacdec.SBR_G_LIM_BOOST_BLOCK_EXPONENT_ARRAY_FIELD) + r8] = r0;
      M[($aacdec.sbr_info + $aacdec.SBR_Q_M_LIM_BOOST_BLOCK_EXPONENT_ARRAY_FIELD) + r8] = r0;
      M[($aacdec.sbr_info + $aacdec.SBR_S_M_BOOST_BLOCK_EXPONENT_ARRAY_FIELD) + r8] = r0;

      M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_f_noise_band] = Null;
      M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_res_band] = Null;
      M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_res_band2] = Null;
      M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_hi_res_band] = Null;
      ...
      r0 = 0;
      save_delta:
      M[$aacdec.tmp + $aacdec.SBR_delta] = r0;

      r1 = r5 * 6 (int);
      r1 = r1 + r8;
      r1 = M[($aacdec.sbr_np_info + $aacdec.SBR_t_E + 1) + r1];
      r2 = r5 * 3 (int);
      r0 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_t_noise_band];
      r2 = r2 + r0;
      r2 = M[($aacdec.sbr_np_info + $aacdec.SBR_t_Q + 1) + r2];
      ...
      if LE jump dont_increment_curr_t_noise_band;
         ...
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_t_noise_band] = r0;
      ...
      limiter_band_outer_loop:
         ...
         M[($aacdec.tmp + $aacdec.SBR_calc_gain_limiter_band_outer_loop_bound)] = r2;

         M[$aacdec.tmp + $aacdec.SBR_calc_gain_den_mantissa] = Null;
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_den_exponent] = Null;
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_acc1_man] = Null;
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_acc1_exp] = Null;
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_acc2_man] = Null;
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_acc2_exp] = Null;

         // r2 = k
         r0 = r2 + M[$aacdec.tmp + $aacdec.SBR_calc_gain_ftable_lim_last_band_ptr];
         ...
         r7 = M[r0 + 1];
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_acc_loop_bound] = r7;
         ...
         r10 = r7 - r6;
         // M2 = current_res_band
         r0 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_res_band];
         M2 = r0;

         // I1 = ptr to SBR_E_orig[ch][l][current_res_band]
         r1 = M[$aacdec.sbr_info + ($aacdec.SBR_num_env_bands+1)];
         r1 = r1 * r8 (int);
         r0 = r0 + r1;
         r1 = M[($aacdec.sbr_np_info + $aacdec.SBR_E_orig_mantissa_base_ptr) + r5];
         I1 = r0 + r1;
         ...
         r0 = r5 * 6 (int);
         r0 = r0 + r8;
         rMAC = M2 + (&$aacdec.sbr_info + $aacdec.SBR_F_table_high + 1);
         r1 = M2 + (&$aacdec.sbr_info + $aacdec.SBR_F_table_low + 1);
        ...
        PROFILER_STOP(&$aacdec.profile_sbr_calculate_gain_loop1)
         ...
         r0 = M2;
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_res_band] = r0;
         ...
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_acc1_man] = r2;
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_acc1_exp] = r3;
         ...
         Div = rMAC / r0;
            ...
            r1 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_res_band2];
            M2 = r1;
            // M1 = current_hi_res_band
            r1 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_hi_res_band];
            M1 = r1;
            // I0 = ptr to SBR_E_orig[ch][l][current_res_band2]
            r1 = M[$aacdec.sbr_info + $aacdec.SBR_num_env_bands + 1];
            r1 = r1 * r8 (int);
            r1 = r1 + M2;
            r2 = M[($aacdec.sbr_np_info + $aacdec.SBR_E_orig_mantissa_base_ptr) + r5];
            I0 = r1 + r2;
            // I7 = ptr to SBR_E_curr[ch][ml1][l]
            r1 = M[$aacdec.sbr_info + $aacdec.SBR_M];
            r1 = r1 * r8 (int);
            r1 = r1 + M3;
            r2 = M[($aacdec.tmp_mem_pool + $aacdec.SBR_E_current_base_ptr) + r5];
            I7 = r1 + r2;
            r0 = M[$aacdec.sbr_info + $aacdec.SBR_bs_limiter_gains];
         r2 = DivResult;
         ...
         M[$aacdec.tmp_mem_pool + $aacdec.SBR_G_max_mantissa] = r2;
         M[$aacdec.tmp_mem_pool + $aacdec.SBR_G_max_exponent] = r3;
         ...
         r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_G_lim_boost_exponent_ptr];
         I5 = r0 + M3;

         // I1 = ptr to SBR_Q_M_lim_mantissa[l][ml1]
         r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_Q_M_lim_boost_mantissa_ptr];
         I1 = r0 + M3;
         // I6 = ptr to SBR_Q_M_lim_exponent[l][ml1]
         r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_Q_M_lim_boost_exponent_ptr];
         I6 = r0 + M3;

         // I3 = ptr to SBR_S_M_mantissa[l][ml1]
         r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_S_M_boost_mantissa_ptr];
         I3 = r0 + M3;
         // I4 = ptr to SBR_S_M_exponent[l][ml1]
         r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_S_M_boost_exponent_ptr];
         I4 = r0 + M3;
         ...
         rMAC = M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_acc1_man];
         r2 = SIGNDET rMAC;
         ...
         // den = max(den, 1e-12)
         r4 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_den_exponent] ;
         r1 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_den_mantissa];
         ...
         Div = rMAC / r1;
            ...
            r0 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_acc1_exp] + r1;
         r1 = DivResult;
         ...
         // r2 = k
         r2 = M[($aacdec.tmp + $aacdec.SBR_calc_gain_limiter_band_outer_loop_bound)];

         M[$aacdec.sbr_limiter_band_g_boost_mantissa + r2] = r1;
         M[$aacdec.sbr_limiter_band_g_boost_exponent + r2] = r0;

         r0 = M2;
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_res_band2] = r0;
         r0 = M1;
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_current_hi_res_band] = r0;

      r2 = r2 + 1;
      r3 = M[$aacdec.sbr_info + $aacdec.SBR_bs_limiter_bands];
      r3 = M[($aacdec.tmp_mem_pool + $aacdec.SBR_N_L) + r3];
      ...
      L5 = 0;
      r0 = M[($aacdec.sbr_info + $aacdec.SBR_S_M_BOOST_BLOCK_EXPONENT_ARRAY_FIELD) + r8];
      Null = r0 AND 1;
     ...
     PROFILER_START(&$aacdec.profile_sbr_calculate_gain_loop3)
      ...
      M[$aacdec.tmp + $aacdec.SBR_calc_gain_save_ch] = r5;
      M[$aacdec.tmp + $aacdec.SBR_calc_gain_save_l] = r8;
      ...
      lim_boost_outer_loop:
         ...
         M[$aacdec.tmp + $aacdec.SBR_calc_gain_lim_boost_outer_loop_index] = r2;
         r7 = M[$aacdec.sbr_limiter_band_g_boost_exponent + r2];

         r0 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_save_l];
         r5 = M[($aacdec.sbr_info + $aacdec.SBR_G_LIM_BOOST_BLOCK_EXPONENT_ARRAY_FIELD) + r0];     // r5 = SBR_G_lim_block_exponent[l]
         r3 = M[($aacdec.sbr_info + $aacdec.SBR_S_M_BOOST_BLOCK_EXPONENT_ARRAY_FIELD) + r0];       // r3 = SBR_S_M_block_exponent[l]
         r8 = M[($aacdec.sbr_info + $aacdec.SBR_Q_M_LIM_BOOST_BLOCK_EXPONENT_ARRAY_FIELD) + r0];   // r8 = SBR_Q_M_lim_block_exponent[l]
         ...
         // r6 = SBR_G_boost[l][k]
         r6 = M[$aacdec.sbr_limiter_band_g_boost_mantissa + r2];
         ...
         do lim_boost_loop;
            ...
            r0 = r0 * r6 (frac), // r0 = SBR_G_lim_mantissa[l][m] * SBR_G_boost_mantissa[l][k]
             r1 = M[I2, 1];   // r1 = SBR_G_lim_exponent[l][m]
            ...
            M[I1, 1] = r1;    // SBR_G_lim_boost_mantissa[l][m] = r1
            ...
            if NZ jump s_m_ne_zero;
               M[I7, 1] = r1; // SBR_S_M_boost_mantissa[l][m] = 0
               I5 = I3;       // I5 <- SBR_Q_M_lim_boost[l][m]
               r0 = M[I3, 1],    // r0 = SBR_Q_M_lim_mantissa[l][m]
                r4 = M[I4, 1];   // r4 = SBR_Q_M_lim_exponent[l][m]
            ...
            s_m_ne_zero:
               M[I3, 1] = r1,  // SBR_Q_M_lim_boost_mantissa[l][m] = 0
                r4 = M[I6, 1]; // r4 = SBR_S_M_exponent[l][m]
               I5 = I7;       // I5 <- SBR_S_M_boost[l][m]
               // r3 = SBR_S_M_exponent[l][m] + SBR_G_boost_exponent[l][k] - SBR_S_M_block_exponent[l]
               r3 = r4 + M1;
               r0 = M[I7, 1]; // r0 = SBR_S_M_boost_mantissa[l][m]
               I4 = I4 + 1;
               L4 = L5;
            end_if_s_m_eq_zero:
      ...
      r2 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_lim_boost_outer_loop_index];
      r2 = r2 + 1;
      r1 = M[$aacdec.sbr_info + $aacdec.SBR_bs_limiter_bands];
      r0 = M[($aacdec.tmp_mem_pool + $aacdec.SBR_N_L) + r1];
      Null = r2 - r0;
      if LT jump lim_boost_outer_loop;

      r5 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_save_ch];
      r8 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_save_l];
     ...
     PROFILER_STOP(&$aacdec.profile_sbr_calculate_gain_loop3)
      ...
      r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_G_lim_boost_mantissa_ptr];
      M[$aacdec.tmp_mem_pool + $aacdec.SBR_G_lim_boost_mantissa_ptr] = r0 + r1;
      ...
      r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_Q_M_lim_boost_mantissa_ptr];
      M[$aacdec.tmp_mem_pool + $aacdec.SBR_Q_M_lim_boost_mantissa_ptr] = r0 + r1;
      ...
      r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_S_M_boost_mantissa_ptr];
      M[$aacdec.tmp_mem_pool + $aacdec.SBR_S_M_boost_mantissa_ptr] = r0 + r1;
   ...
   r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_G_lim_boost_mantissa_ptr];
   M[$aacdec.tmp_mem_pool + $aacdec.SBR_G_lim_boost_mantissa_ptr] = r0 - r2;

   r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_Q_M_lim_boost_mantissa_ptr];
   M[$aacdec.tmp_mem_pool + $aacdec.SBR_Q_M_lim_boost_mantissa_ptr] = r0 - r2;

   r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_S_M_boost_mantissa_ptr];
   M[$aacdec.tmp_mem_pool + $aacdec.SBR_S_M_boost_mantissa_ptr] = r0 - r2;
...
.MODULE $M.aacdec.update_den;
   ...
   r10 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_den_mantissa];
   if Z jump save_den;
      r4 = M[$aacdec.tmp + $aacdec.SBR_calc_gain_den_exponent];
      // equalise exponents
      r7 = r1 - r4;
   ...
   M[$aacdec.tmp + $aacdec.SBR_calc_gain_den_mantissa] = r0 + r10;
   M[$aacdec.tmp + $aacdec.SBR_calc_gain_den_exponent] = r1;
