...
.MODULE $M.aacdec.ps_decorrelate;
   ...
   call $aacdec.initialise_ps_decorrelation_for_hybrid_freq_bins_flash;

   filter_outer_loop:


      M[$aacdec.tmp + $aacdec.PS_DECORRELATION_HYBRID_MODE] = r0;

      // for freq_band={(0:9)||(10:21)}
      filter_freq_bands_loop:


         r2 = &$aacdec.frequency_border_table_20_par_bands + M1;
         r7 = M[r2];  // r7 = start_k = frequency_border_table_20_par_bands[freq_band]

         r1 = M[r2+1];// r1 = frequency_border_table_20_par_bands[freq_band+1]
         ...
         r2 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_HYBRID_MODE];
         if NZ r1 = r7 + r2;
         M[$aacdec.tmp + $aacdec.PS_DECORRELATION_END_SUBBAND_OF_FREQ_BAND] = r1;
         ...
         filter_subbands_loop:
            ...
            if GT jump subband_within_delay_band;
               ...
               r0 = M[$aacdec.ps_info + $aacdec.PS_ALLPASS_FEEDBACK_BUFFER_INDICES + 0];
               M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_INDICES + 0] = r0;
               M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_INDICES + 1] = Null;
               r0 = M[$aacdec.ps_info + $aacdec.PS_ALLPASS_FEEDBACK_BUFFER_INDICES + 1];
               M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_INDICES + 2] = r0;


               Null = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_HYBRID_MODE];
               if NZ jump initialise_filter_for_hybrid_qmf_subband;
                  ...
                  r3 = &$aacdec.ps_prev_frame_last_two_qmf_samples_real;
                  r5 = &$aacdec.ps_prev_frame_last_two_qmf_samples_imag;
                  ...
                  r2 = r2 * $aacdec.PS_NUM_ALLPASS_LINKS (int);
                  r2 = r2 + M[$aacdec.tmp + $aacdec.PS_DECORRELATION_G_DECAY_SLOPE_FILTER_TABLE_BASE_ADDR];
                  ...
                  DO allpass_filter_g_decay_slope_loop;
                     r1 = M[r2 + r0];
                     r1 = r1 ASHIFT 8;
                     M[($aacdec.tmp + $aacdec.PS_G_DECAY_SLOPE_FILTER_A) + r0] = r1;
                     r0 = r0 + 1;
               ...
               // Initalisation for Allpass-chain filtering of next Hybrid sub-subband
                  ...
                  r0 = r7 + M[$aacdec.tmp + $aacdec.PS_DECORRELATION_FLASH_TABLES_DM_ADDRESS];
                  I0 = r0;
                  I4 = r0 + $aacdec.PS_NUM_HYBRID_SUB_SUBBANDS;

                  // [I2,I6] -> phi_fract_hybrid_allpass[m=0][k]
                  r3 = r7 * $aacdec.PS_NUM_ALLPASS_LINKS (int);
                  r0 = r3 + M[$aacdec.tmp + $aacdec.PS_DECORRELATION_FLASH_TABLES_DM_ADDRESS];
                  I2 = r0 + (2 * $aacdec.PS_NUM_HYBRID_SUB_SUBBANDS);
                  I6 = I2 + ($aacdec.PS_NUM_HYBRID_SUB_SUBBANDS * $aacdec.PS_NUM_ALLPASS_LINKS);

                  r3 = &$aacdec.ps_prev_frame_last_two_hybrid_samples_real;
                  r5 = &$aacdec.ps_prev_frame_last_two_hybrid_samples_imag;
            ...
            subband_within_delay_band:
               ...
               if GE jump subband_within_short_delay_band;
                  ...
                  r8 = M[$aacdec.ps_info + $aacdec.PS_DECORRELATION_LONG_DELAY_BAND_BUFFER_INDICE];

                  // [I2,I6] -> PS_LONG_DELAY_BAND_BUFFER[k][Long_D_Delay_indice]
                  r2 = r7 - ($aacdec.PS_DECORRELATION_NUM_ALLPASS_BANDS + 1);
                  r0 = r2 * $aacdec.PS_DECORRELATION_LONG_DELAY_IN_SAMPLES (int);
                  r0 = r0 + r8;
                  I2 = &$aacdec.ps_long_delay_band_buffer_real + r0;
                  I6 = &$aacdec.ps_long_delay_band_buffer_imag + r0;
                  // r2 = k
                  r2 = r7;

                  r0 = $aacdec.PS_DECORRELATION_LONG_DELAY_IN_SAMPLES;
                  M[$aacdec.tmp + $aacdec.PS_DECORRELATION_DELAY_IN_SAMPLES] = r0;
               ...
               subband_within_short_delay_band:
                  ...
                  r0 = r2 * $aacdec.PS_DECORRELATION_SHORT_DELAY_IN_SAMPLES (int);
                  I2 = &$aacdec.ps_short_delay_band_buffer_real + r0;
                  I6 = &$aacdec.ps_short_delay_band_buffer_imag + r0;
                  // r2 = k
                  r2 = r7;
            ...
            r0 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_SK_IN_REAL_BASE_ADDR] + r2;
            I3 = r0; // I3 -> real(S_k[n=0][k])
            r0 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_SK_IN_IMAG_BASE_ADDR] + r2;
            I7 = r0; // I7 -> imag(S_k[n=0][k])

            r0 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_DK_OUT_REAL_BASE_ADDR] + r2;
            I1 = r0; // I1 -> real(D_k[n=0][k])
            r0 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_DK_OUT_IMAG_BASE_ADDR] + r2;
            I5 = r0; // I5 -> imag(D_k[n=0][k])
            ...
            filter_time_samples_loop:
               ...
               if LE jump subband_is_within_allpass_band;
                  ...
                  r0 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_DELAY_IN_SAMPLES];
               ...
               //             ------------------------>| * -a[m]*G_DecaySlope[sb] |----->----------------------\xA6                      //
               //             |                        |__________________________|                            \xA6                      //
               //             |                    _________________________                                   \xA6                      //
               //             |                   |                         |                                  \xA6                      //
               // AP_input[m]-->[Z^-d(m)]--(+)--->| * Q_fractAllPass[sb][m] |-------------------------------->(+)------> AP_output[m] //
               //                           \xA6     |_________________________| allpass_feedback_component            \xA6                 //
               //                           \xA6                                                                       \xA6                 //
               //                           \xA6            _________________________                                  \xA6                 //
               //                           \xA6           |                         |                                 \xA6                 //
               //                           -----<------| * a[m]*G_DecaySlope[sb] |<------------[Z^-d(m)]<----------\xA6                 //
               ...
               /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                  ...
                  M0 = I3;
                  I3 = &$aacdec.tmp + $aacdec.PS_G_DECAY_SLOPE_FILTER_A;


                  DO allpass_filter_loop;

                     r0 = M[($aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_M_EQS_TWO_ADDR - 1) + r10];
                     r4 = M[($aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_INDICES - 1) + r10];
                     r0 = r0 + r4;
                     ...
                     Null = r5 - 6;
                     if Z r4 = 0;
                     M[($aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_INDICES - 1) + r10] = r4;

                     // r1 = real(phi_fract_allpass[k][m])
                     r1 = M[($aacdec.tmp + $aacdec.PS_DECORRELATION_PHI_FRACT_ALLPASS_REAL_SUBBAND_VALUES - 1) + r10];
                     // r8 = imag(phi_fract_allpass[k][m])
                     r8 = M[($aacdec.tmp + $aacdec.PS_DECORRELATION_PHI_FRACT_ALLPASS_IMAG_SUBBAND_VALUES - 1) + r10];

                     r5 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_SIZE];
                     ...
                     rMAC = r7 * r1,
                      r5 = M[I3,1];  // r5 = gDecaySlope_filter_a[k][m]
                     rMAC = rMAC - r6 * r8;
                     ...
                     r0 = r0 + M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_SIZE];
                  ...
                  // r6 = real(S_k[(n+1)-2][k])
                  r6 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_FILTER_INPUT_N_MINUS_ONE_REAL];
                  // r4 = imag(S_k[(n+1)-2][k])
                  r4 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_FILTER_INPUT_N_MINUS_ONE_IMAG];

                  M[$aacdec.tmp + $aacdec.PS_DECORRELATION_FILTER_INPUT_N_MINUS_ONE_REAL] = r0;
                  M[$aacdec.tmp + $aacdec.PS_DECORRELATION_FILTER_INPUT_N_MINUS_ONE_IMAG] = r1;
               ...
               // r0 = freq_band
               r0 = M1;
               r1 = M[$aacdec.tmp + $aacdec.PS_GAIN_TRANSIENT_RATIO_ADDR];
               // r0 = parameter_band
               r0 = M[&$aacdec.map_freq_bands_to_20_par_bands_x_num_samples_per_frame_table + r0];

               // r0 = G_transient_ratio[n][parameter_band]
               r0 = r0 + M3;
               r5 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_NUM_FREQ_BINS_PER_SAMPLE];
               r0 = M[r0 + r1];
               ...
               if NZ jump end_if_crossing_xsbr_memory_partition;
                  ...
                  if NZ jump not_crossing_xsbr_thfgen_partition;
                     ...
                     I1 = &$aacdec.fmp_remains + M2;
                     // I5 -> imag(X_sbr[ch=1][k][l=SBR_tHFAdj+6]) = imag(D_k[n=6][k])
                     I5 = &$aacdec.overlap_add_right + M2;
                  ...
                  if NZ jump not_crossing_xsbr_thfgen_plus_16_partition;
                     ...
                     I5 = &$aacdec.x_input_buffer_right + M2;
                     jump end_if_crossing_xsbr_memory_partition;
                  ...
                  if NZ jump end_if_crossing_xsbr_memory_partition;
                     ...
                     I5 = (&$aacdec.fmp_remains + ($aacdec.X_SBR_WIDTH * 26)) + M2;
            ...
            if GT jump end_of_filter_subbands_loop_iteration;
               ...
               // ps_prev_frame_last_two_samples[k][1] = {ps_X_hybrid\xA6\xA6X_SBR}[ch=0][k][n=31+SBR_tHFAdj]
               r1 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_NON_HYBRID_QMF_CHANNEL_NUMBER];
               r4 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_LAST_TWO_SAMPLES_BUFFER_REAL_ADDR];
               r1 = r1 * 2 (int);
               r6 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_LAST_TWO_SAMPLES_BUFFER_IMAG_ADDR];
               r4 = r4 + r1;
               r6 = r6 + r1;
               r2 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_FILTER_INPUT_N_MINUS_ONE_REAL];
               r1 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_FILTER_INPUT_N_MINUS_ONE_IMAG];
               M[r4 + 1] = r2;   // real(filter_input[k][n=-1]) in next frame
               M[r6 + 1] = r1;   // imag(filter_input[k][n=-1]) in next frame

               // ps_prev_frame_last_two_samples[k][0] = {ps_X_hybrid\xA6\xA6X_SBR}[ch=0][k][n=30+SBR_tHFAdj]
               r0 = r5 * 2 (int);
               r3 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_M_EQS_ZERO_ADDR];
               I3 = I3 - r0;
               I7 = I7 - r0;
               r0 = M[I3,0],
                r2 = M[I7,0];
               r1 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_M_EQS_ONE_ADDR];
               M[r4] = r0;  // real(filter_input[k][n=-2]) in next frame
               M[r6] = r2;  // imag(filter_input[k][n=-2]) in next frame

               // increment pointers to {Hybrid\xA6\xA6QMF}_allpass_feedback_buffer to point to the next successive subband
               r2 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_M_EQS_TWO_ADDR];
               r3 = r3 + 3;
               r1 = r1 + 4;
               r2 = r2 + 5;
               M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_M_EQS_ZERO_ADDR] = r3;
               M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_M_EQS_ONE_ADDR] = r1;
               M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_M_EQS_TWO_ADDR] = r2;
            ...
            r7 = r7 + 1;
            Null = r7 - M[$aacdec.tmp + $aacdec.PS_DECORRELATION_END_SUBBAND_OF_FREQ_BAND];
         if LT jump filter_subbands_loop;

         r0 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_SUBBAND_LOOP_BOUND];
         M1 = M1 + 1;
         Null = r0 - M1;
      ...
      M[$aacdec.tmp + $aacdec.PS_DECORRELATION_SUBBAND_LOOP_BOUND] = r0;

      call $aacdec.initialise_ps_decorrelation_for_qmf_freq_bins_flash;


      r0 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_HYBRID_MODE];
      r0 = r0 - 1;
   ...
   r0 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_INDICES + 0];
   M[$aacdec.ps_info + $aacdec.PS_ALLPASS_FEEDBACK_BUFFER_INDICES + 0] = r0;
   r0 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_ALLPASS_FEEDBACK_BUFFER_INDICES + 2];
   M[$aacdec.ps_info + $aacdec.PS_ALLPASS_FEEDBACK_BUFFER_INDICES + 1] = r0;

   r0 = M[$aacdec.ps_info + $aacdec.PS_DECORRELATION_LONG_DELAY_BAND_BUFFER_INDICE];
   r0 = r0 + 4;
   r1 = $aacdec.PS_DECORRELATION_LONG_DELAY_IN_SAMPLES;
   r1 = r0 - r1;
   if GE r0 = r1;
   M[$aacdec.ps_info + $aacdec.PS_DECORRELATION_LONG_DELAY_BAND_BUFFER_INDICE] = r0;


   r8 = M[$aacdec.tmp + $aacdec.PS_DECORRELATION_TEMP_R8];
...
// ********************************************************
   ...
   M[$aacdec.tmp + $aacdec.PS_DECORRELATION_NON_HYBRID_QMF_CHANNEL_NUMBER] = r2;
   ...
   M[$aacdec.tmp + $aacdec.PS_DECORRELATION_FILTER_INPUT_N_MINUS_ONE_REAL] = r1;
   r1 = M[r5 + r0];  // imag(filter_input[k][n=-1])
   M[$aacdec.tmp + $aacdec.PS_DECORRELATION_FILTER_INPUT_N_MINUS_ONE_IMAG] = r1;

   // load phi_fract_{hybrid\xA6\xA6qmf}_allpass[m][k] values from Flash
   do copy_phi_fract_allpass_flash_values_loop;
      r0 = M[I2,1],
       r1 = M[I6,1];
      r0 = r0 ASHIFT 8;
      r1 = r1 ASHIFT 8;
      M[($aacdec.tmp + $aacdec.PS_DECORRELATION_PHI_FRACT_ALLPASS_REAL_SUBBAND_VALUES - 1) + r10] = r0;
      M[($aacdec.tmp + $aacdec.PS_DECORRELATION_PHI_FRACT_ALLPASS_IMAG_SUBBAND_VALUES - 1) + r10] = r1;
      nop;
