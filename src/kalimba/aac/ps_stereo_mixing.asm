...
.MODULE $M.aacdec.ps_stereo_mixing;
   ...
   call $aacdec.initialise_ps_stereo_mixing_for_hybrid_freq_bins_flash;


   mixing_outer_loop:


      M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_HYBRID_MODE] = r0;
      ...
      mixing_freq_bands_loop:
         ...
         r0 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_SK_REAL_BASE_ADDR];
         r1 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_DK_REAL_BASE_ADDR];
         r3 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_SK_IMAG_BASE_ADDR];
         r4 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_DK_IMAG_BASE_ADDR];
         ...
         M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_FREQ_BAND_START_FREQ] = r0;
         ...
         r2 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_HYBRID_MODE];
         if NZ r1 = r0 + r2;
         M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_END_SUBBAND_OF_FREQ_BAND] = r1;

         // adjusted when mixing hybrid spectrum so that storage is not allocated to the zeroed hybrid sub-subbands (4:5)
         M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_ADJUSTED_END_SUBBAND_OF_FREQ_BAND] = r1;
         ...
         mixing_time_envelope_loop:
            ...
            r0 = &$aacdec.map_freq_bands_to_20_par_bands_table + M1;
            ...
            r4 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_IID_ZERO_SCALE_FACTOR_TABLE_POINTER];
            // r1 = PS_IID_INDEX[envelope][paramter_band]
            r1 = M[($aacdec.ps_info + $aacdec.PS_IID_INDEX) + r0];

            // r10 = PS_ICC_INDEX[envelope][parameter_band]
            r10 = M[($aacdec.ps_info + $aacdec.PS_ICC_INDEX) + r0];
            ...
            r5 = M[$aacdec.ps_cos_alpha_table + r10];
            ...
            r6 = M[$aacdec.ps_sin_alpha_table + r10];
            // r4 = alpha_angle[envelope][parameter_band] / 2
            r4 = M[$aacdec.ps_alpha_angle_table + r10];
            ...
            // save c1 and c2
            M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_SCALE_FACTOR_ONE] = r3;
            M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_SCALE_FACTOR_TWO] = r2;
            ...
            r6 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_SCALE_FACTOR_ONE];  // r6 = c1
            r7 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_SCALE_FACTOR_TWO];  // r7 = c2
            ...
            r4 = M[($aacdec.ps_info + $aacdec.PS_BORDER_POSITION) + r8];
            r5 = M[($aacdec.ps_info + $aacdec.PS_BORDER_POSITION + 1) + r8];
            r6 = 1;
            r5 = r5 - r4;
            if LT r5 = r6;

            // r5 = (int)(1 / envelope_length)
            r5 = M[($aacdec.sbr_one_over_x - 1) + r5];

            r10 = M1;   // r10 = freq_band
            M3 = r4;    // M3 = PS_BORDER_POSITION[envelope]

            // rMAC = h11[env-1] = ps_h11_previous_envelope[freq_band][env]
            rMAC = M[$aacdec.ps_h11_previous_envelope + r10];
            // ps_h11_previous_envelope[freq_band][env+1] = h11[env]
            M[$aacdec.ps_h11_previous_envelope + r10] = r1;
            ...
            M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_DELTA_H11] = r1;
            ...
            M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_DELTA_H12] = r0;
            ...
            M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_DELTA_H21] = r2;
            ...
            M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_DELTA_H22] = r3;
            ...
            r5 = M[($aacdec.ps_info + $aacdec.PS_BORDER_POSITION + 1) + r8];
            M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_BORDER_END] = r5;

            rMAC = $aacdec.PS_STEREO_MIXING_SQTR_2_OVER_TWO;
            M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_ENVELOPE] = r8;
            ...
            r2 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_INTER_SUBBAND_STRIDE];
            M2 = r2;
            ...
            mixing_time_samples_loop:
               ...
               Null = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_HYBRID_MODE];
               if NZ jump end_if_crossing_xsbr_memory_partition;
                  ...
                  if NZ jump not_crossing_xsbr_thfgen_plus_16_partition;
                     ...
                     I2 = &$aacdec.x_input_buffer_right;
                     jump end_if_crossing_xsbr_memory_partition;
                  ...
                  if NZ jump end_if_crossing_xsbr_memory_partition;
                     ...
                     I2 = &$aacdec.fmp_remains + ($aacdec.X_SBR_WIDTH * 26);
               end_if_crossing_xsbr_memory_partition:

               // r5 = start_k
               r5 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_FREQ_BAND_START_FREQ];
               ...
               if Z jump freq_band_start_freq_assigned;
                  ...
                  if LT jump freq_band_start_freq_assigned;
                     r5 = r5 - 2;
                     r4 = r5 + 1;
                     M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_ADJUSTED_END_SUBBAND_OF_FREQ_BAND] = r4;
               freq_band_start_freq_assigned:

               r4 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_INTER_SUBBAND_STRIDE];
               r4 = r4 * r5 (int);
               ...
               r6 = r6 + M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_DELTA_H11];
               // H12[n] = H12[n-1] + delta_H12
               r0 = r0 + M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_DELTA_H12];
               // H21[n] = H21[n-1] + delta_H21
               r7 = r7 + M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_DELTA_H21];
               // H22[n] = H22[n-1] + delta_H22
               r8 = r8 + M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_DELTA_H22];

               r10 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_END_SUBBAND_OF_FREQ_BAND];
               r10 = r10 - M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_FREQ_BAND_START_FREQ];
               ...
               r4 = M2;
               r5 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_ADJUSTED_END_SUBBAND_OF_FREQ_BAND];
               r1 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_INTER_SAMPLE_STRIDE];
               r4 = r4 * r5 (int);
               ...
               r4 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_BORDER_END];
               M3 = M3 + 1;
               Null = M3 - r4;
            if LT jump mixing_time_samples_loop;

            r8 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_ENVELOPE];

            r8 = r8 + 1;
            Null = r8 - M[$aacdec.ps_info + $aacdec.PS_NUM_ENV];
         if LT jump mixing_time_envelope_loop;

         I3 = I3 + 1;   // I3 -> h12[freq_band+1][last_env_of_prev_frame] = ps_h12_previous_envelope[freq_band+1][env=0]
         I6 = I6 + 1;   // I6 -> h21[freq_band+1][last_env_of_prev_frame] = ps_h21_previous_envelope[freq_band+1][env=0]
         I7 = I7 + 1;   // I7 -> h22[freq_band+1][last_env_of_prev_frame] = ps_h22_previous_envelope[freq_band+1][env=0]

         r0 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_FREQ_BAND_LOOP_BOUND];
         M1 = M1 + 1;
         Null = r0 - M1;
      ...
      call $aacdec.initialise_ps_stereo_mixing_for_qmf_freq_bins_flash;


      r0 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_HYBRID_MODE];
      r0 = r0 - 1;
   if POS jump mixing_outer_loop;



   r8 = M[$aacdec.tmp + $aacdec.PS_STEREO_MIXING_TEMP_R8];
