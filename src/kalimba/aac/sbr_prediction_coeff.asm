...
.MODULE $M.aacdec.sbr_prediction_coeff;
   ...
   I0 = &$aacdec.tmp + $aacdec.SBR_alpha_0; // alpha_0
   I4 = &$aacdec.tmp + $aacdec.SBR_alpha_1; // alpha_1


   r0 = M[$aacdec.tmp + $aacdec.SBR_phi_22_r];
   r1 = M[$aacdec.tmp + $aacdec.SBR_phi_11_r];
   r6 = M[$aacdec.tmp + $aacdec.SBR_phi_12_r];
   r7 = M[$aacdec.tmp + $aacdec.SBR_phi_12_i];
   ...
   r4 = SIGNDET rMAC;
   M[$aacdec.tmp + $aacdec.SBR_phi_22_r] = r4;        // write scale over phi_22_r
   r8 = rMAC ASHIFT r4;
   ...
   if Z jump alpha_1_zero;
      ...
      r0 = M[$aacdec.tmp + $aacdec.SBR_phi_01_r];
      r5 = M[$aacdec.tmp + $aacdec.SBR_phi_01_i];
      r2 = M[$aacdec.tmp + $aacdec.SBR_phi_02_r];
      ...
      r4 = SIGNDET rMAC;
      r8 = rMAC ASHIFT r4;
      r4 = r4 - M[$aacdec.tmp + $aacdec.SBR_phi_22_r];
      M[$aacdec.tmp + $aacdec.SBR_phi_01_r] = -r4;      // write scale over phi_01_r


      // r10 = Imag[phi(0,1).phi(1,2) - phi(0,2).phi(1,1)]
      r3 = M[$aacdec.tmp + $aacdec.SBR_phi_02_i];
      ...
      r10 = rMAC ASHIFT r4;
      r4 = r4 - M[$aacdec.tmp + $aacdec.SBR_phi_22_r];
      M[$aacdec.tmp + $aacdec.SBR_phi_01_i] = -r4;      // write scale over phi_01_i
   ...
   alpha_1_zero:
      r8 = 0;
      r10 = 0;
      M[$aacdec.tmp + $aacdec.SBR_phi_01_r] = Null;
      M[$aacdec.tmp + $aacdec.SBR_phi_01_i] = Null;
   ...
   writeback_alpha_0:
      ...
      rMAC = r8 * r6;
      r2 = 4;
      r4 = r2 + M[$aacdec.tmp + $aacdec.SBR_phi_01_r];
      r0 = rMAC ASHIFT r4;
      M[I0, 1] = r0;
      rMAC = r10 * r6;
      r4 = r2 + M[$aacdec.tmp + $aacdec.SBR_phi_01_i];
      r1 = rMAC ASHIFT r4;
      M[I0,-1] = r1;
