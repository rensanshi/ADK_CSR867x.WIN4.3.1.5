...
.MODULE $M.aacdec.program_element_config;
   ...
   .CONST NUM_FRONT_CHANNEL_ELEMENTS 0;
   .CONST NUM_SIDE_CHANNEL_ELEMENTS  1;
   .CONST NUM_BACK_CHANNEL_ELEMENTS  2;
   .CONST NUM_LFE_CHANNEL_ELEMENTS   3;
   .CONST NUM_ASSOC_DATA_ELEMENTS    4;
   .CONST NUM_VALID_CC_ELEMENTS      5;
