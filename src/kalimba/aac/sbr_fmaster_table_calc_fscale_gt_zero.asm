...
.MODULE $M.aacdec.sbr_fmaster_table_calc_fscale_gt_zero;
   ...
   // if( (k2/k0) > 2.2449 )
   r0 = M[$aacdec.sbr_info + $aacdec.SBR_k0];
   r1 = r0 ASHIFT 16;
   r1 = r1 * 0x47d600 (frac); // eliminate prefix: 0x47d600 ~= 2.2449/4
   r6 = r2 ASHIFT 14;
   Null = r6 - r1;
   if GT jump two_regions;
      // twoRegions = 0
      M[$aacdec.tmp + $aacdec.SBR_two_regions] = Null;
      // SBR_k1 = SBR_k2
      r1 = r2;
      jump save_k1;
   two_regions:
      // twoRegions = 1
      r1 = 1;
      M[$aacdec.tmp + $aacdec.SBR_two_regions] = r1;
      // SBR_k1 = SBR_k0 * 2
      r1 = r0 * 2 (int);

   save_k1:
   M[$aacdec.tmp_mem_pool + $aacdec.SBR_k1] = r1;
   ...
   r3 = r0 LSHIFT 8;
#else
   r3 = M[$aacdec.sbr_info + $aacdec.SBR_k0];
   r6 = M[(&$aacdec.sbr_log_base2_table - 1) + r1];
   r3 = M[(&$aacdec.sbr_log_base2_table - 1) + r3];
#endif


   // r5 = SBR_bands = temp_1(SBR_bs_freq_scale-1)
   r0 = M[$aacdec.sbr_info + $aacdec.SBR_bs_freq_scale];
   r2 = r6 - r3;
   r5 = M[($aacdec.sbr_fscale_gt_zero_temp_1 - 1) + r0];
   r0 = r2;
   r6 = M[$aacdec.sbr_info + $aacdec.SBR_k0];
   r3 = &$aacdec.tmp + $aacdec.SBR_vDk0_length;

   call $aacdec.form_vDkx;
   Null = M[$aacdec.frame_corrupt];
   if NZ jump $aacdec.corruption;

   r0 = M[$aacdec.tmp + $aacdec.SBR_vDk0_length];
   // SBR_numBands0 + 1
   r5 = r0 + 1;
   ...
   r0 = M[$aacdec.tmp + $aacdec.SBR_two_regions];
   Null = r0;
   if Z jump not_two_regions;
      ...
      r0 = M[$aacdec.sbr_info + $aacdec.SBR_bs_alter_scale];
      r6 = M[($aacdec.sbr_fscale_gt_zero_temp_2) + r0];

      r1 = M[$aacdec.sbr_info + $aacdec.SBR_k2];
      ...
      r0 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_k1];
      r0 = r0 + (&$aacdec.sbr_log_base2_table - 1);
      r2 = M[$flash.windowed_data16.address];
      call $aacdec.sbr_read_one_word_from_flash;
      ...
      r3 = r0 LSHIFT 8;
#else
      r2 = M[(&$aacdec.sbr_log_base2_table - 1) + r1];
      r3 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_k1];
      r3 = M[(&$aacdec.sbr_log_base2_table - 1) + r3];
#endif
      ...
      r2 = r2 - r3;
      r0 = r2 * r6 (frac);
      r6 = M[$aacdec.tmp_mem_pool + $aacdec.SBR_k1];
      r3 = &$aacdec.tmp + $aacdec.SBR_vDk1_length;
      ...
      r0 = M[$aacdec.tmp + $aacdec.SBR_vDk1_length];
      // r5 = SBR_numBands1 - 1
      r5 = r0 - 1;
      ...
      r5 = r5 + r0;
      M[$aacdec.sbr_info + $aacdec.SBR_Nmaster] = r5;
      ...
      r0 = M[$aacdec.tmp + $aacdec.SBR_vDk0_length];
      r1 = M[$aacdec.tmp + $aacdec.SBR_vDk1_length];
      r0 = r0 + r1;
      r0 = r0 * 2 (int);
      r0 = r0 + 2;
   ...
   not_two_regions:
      ...
      r0 = r5 - 1;
      M[$aacdec.sbr_info + $aacdec.SBR_Nmaster] = r0;

      // base pointer to SBR_vk0
      I1 = r1;
      // base pointer to SBR_Fmaster
      I2 = &$aacdec.sbr_info + $aacdec.SBR_Fmaster;
...
.MODULE $M.aacdec.form_vDkx;
   ...
   r0 = r0 AND 0xFFFF00;   // Round the input to the 2^x code
   ...
   rMAC = M[r1 + $aacdec.sbr_pow2_table];
   r1 = M[r1 + ($aacdec.sbr_pow2_table + 1)];
   r1 = r1 - rMAC;
