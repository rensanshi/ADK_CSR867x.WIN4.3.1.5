...
.MODULE $M.aacdec.huffman_start;
   ...
   r3 = 1;
   r2 = r2 - r3;
   r3 = r3 LSHIFT r2, //  r3=1<<(bitpos-1)
    r2 = M[I0,1];    // r2 = current word from bitstream, I0 = ptr to next word
...
.MODULE $M.aacdec.huffman_finish;
   ...
   r2 = -1;
   Null = r3;
   if NEG r3 = r2; // r3 == 0x800000 ? if so, make get_bitpos=24
   if POS r3 = SIGNDET r3;
   r3 = 23 - r3;
   M[$aacdec.get_bitpos] = r3;
   ...
   r0 = I0 - r0;
   if NEG r0 = r0 + L0;
   r0 = r0 * BITPOS_START (int);
   r0 = r0 + M[$aacdec.getbits_saved_bitpos];
   r0 = r0 + M[$aacdec.read_bit_count];
   M[$aacdec.read_bit_count] = r0 - r3;
...
.MODULE $M.aacdec.huffman_getpair;
   ...
   r5 = M[$aacdec.huffman_offsets + r4];
   if Z jump read_sign_bits;

      // add the offset to each value
      r0 = r0 + r5;
      r1 = r1 + r5,
       M[I1,1] = r0;       // write decoded word y to buffer
...
.MODULE $M.aacdec.huffman_getquad;
   ...
   // deal with sign bits or offsetting huffman value
   r6 = M[$aacdec.huffman_offsets + r4];
   if Z jump read_sign_bits;
      ...
      r1 = r1 LSHIFT -4;
      r1 = r1 + r6,
       M[I1,1] = r5;       // write decoded word w to buffer

      // extract y (next 2 bits)
      r5 = r0 AND 0xC;
      r5 = r5 LSHIFT -2;
      r5 = r5 + r6,
       M[I1,1] = r1;       // write decoded word x to buffer

      // extract z (LS 2 bits)
      r1 = r0 AND 0x3;
      r1 = r1 + r6,
       M[I1,1] = r5;       // write decoded word y to buffer
      // write decoded word z to buffer
      M[I1,1] = r1;
...
.MODULE $M.aacdec.huffman_getsf;
   ...
   r0 = M[$aacdec.huffman_cb_table + 0];
   I1 = r0;
   r5 = -12;
