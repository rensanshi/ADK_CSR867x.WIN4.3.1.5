...
.CONST HUFFMAN_bookscl_SIZE      120;
.CONST HUFFMAN_book1_SIZE        80;
.CONST HUFFMAN_book2_SIZE        80;
.CONST HUFFMAN_book3_SIZE        80;
.CONST HUFFMAN_book4_SIZE        80;
.CONST HUFFMAN_book5_SIZE        80;
.CONST HUFFMAN_book6_SIZE        80;
.CONST HUFFMAN_book7_SIZE        64;
.CONST HUFFMAN_book8_SIZE        64;
.CONST HUFFMAN_book9_SIZE        168;
.CONST HUFFMAN_book10_SIZE       168;
.CONST HUFFMAN_book11_SIZE       288;
...
// huffman table 0 is the scalefactor table
// huffman tables 1-11 are the huffman tables 1-11
#ifdef AACDEC_PACK_SCALEFACTOR_HUFFMAN_IN_FLASH
   .VAR   huffman_cb_table[12];
#else
   // get the scalefactor table from RAM
   .VAR   huffman_cb_table[12] = &huff_bookscl;
#endif


// list of huffman tables in flash
.VAR huffman_packed_list[] =
#ifdef AACDEC_PACK_SCALEFACTOR_HUFFMAN_IN_FLASH
                                    &huff_packed_bookscl,
#else
                                    0,
...
.VAR huffman_table_sizes_div_2[] =
                                    HUFFMAN_bookscl_SIZE / 2,
                                    HUFFMAN_book1_SIZE / 2,
                                    HUFFMAN_book2_SIZE / 2,
                                    HUFFMAN_book3_SIZE / 2,
                                    HUFFMAN_book4_SIZE / 2,
                                    HUFFMAN_book5_SIZE / 2,
                                    HUFFMAN_book6_SIZE / 2,
                                    HUFFMAN_book7_SIZE / 2,
                                    HUFFMAN_book8_SIZE / 2,
                                    HUFFMAN_book9_SIZE / 2,
                                    HUFFMAN_book10_SIZE / 2,
                                    HUFFMAN_book11_SIZE / 2;


// -- Packed huffman tables --
#ifdef AACDEC_PACK_SCALEFACTOR_HUFFMAN_IN_FLASH
   // scalefactor huffman table in flash
   .VAR/DMCONST_WINDOWED16 huff_packed_bookscl[180] =
...
#else
   // scalefactor huffman table in RAM
   .VAR huff_bookscl[120] =
      0x00183C,  0x003001,  0x00183B,  0x83A83D,  0x003001,  0x00183E,
      0x83F839,  0x004001,  0x002001,  0x840838,  0x841837,  0x005001,
      0x002001,  0x836842,  0x001843,  0x844835,  0x005001,  0x002001,
      0x845834,  0x001833,  0x832846,  0x006001,  0x002001,  0x847831,
      0x002001,  0x830848,  0x82F849,  0x006001,  0x002001,  0x82E84A,
      0x002001,  0x84B84C,  0x84E84D,  0x006001,  0x002001,  0x82B82D,
      0x002001,  0x84F82C,  0x82982A,  0x006001,  0x002001,  0x828850,
      0x002001,  0x827851,  0x826852,  0x007001,  0x003001,  0x001853,
      0x823825,  0x002001,  0x821855,  0x822824,  0x006001,  0x002001,
      0x820854,  0x002001,  0x859857,  0x81F81E,  0x009001,  0x004001,
      0x002001,  0x81D856,  0x81B81A,  0x002001,  0x81881C,  0x001858,
      0x816819,  0x016001,  0x007001,  0x003001,  0x001817,  0x81585A,
      0x002001,  0x803813,  0x802801,  0x007001,  0x003001,  0x001800,
      0x863862,  0x002001,  0x865864,  0x875866,  0x004001,  0x002001,
      0x85B861,  0x85D85C,  0x002001,  0x85F85E,  0x868860,  0x010001,
      0x008001,  0x004001,  0x002001,  0x87086F,  0x872871,  0x002001,
      0x874873,  0x86986E,  0x004001,  0x002001,  0x86B86A,  0x86D86C,
      0x002001,  0x806876,  0x809808,  0x008001,  0x004001,  0x002001,
      0x80580A,  0x878867,  0x002001,  0x804877,  0x80F807,  0x004001,
      0x002001,  0x812810,  0x811814,  0x002001,  0x80C80B,  0x80D80E;
#endif


.VAR/DMCONST_WINDOWED16 huff_packed_book1[120] =
...
.VAR/DMCONST_WINDOWED16 huff_packed_book2[120] =
...
.VAR/DMCONST_WINDOWED16 huff_packed_book3[120] =
...
.VAR/DMCONST_WINDOWED16 huff_packed_book4[120] =
...
.VAR/DMCONST_WINDOWED16 huff_packed_book5[120] =
...
.VAR/DMCONST_WINDOWED16 huff_packed_book6[120] =
...
.VAR/DMCONST_WINDOWED16 huff_packed_book7[96] =
...
.VAR/DMCONST_WINDOWED16 huff_packed_book8[96] =
...
.VAR/DMCONST_WINDOWED16 huff_packed_book9[252] =
   0x0018,   0x0000,   0x2001,   0x8018,   0x2000,   0x5001,   0x0018,   0x2100,
...
.VAR/DMCONST_WINDOWED16 huff_packed_book10[252] =
...
.VAR/DMCONST_WINDOWED16 huff_packed_book11[432] =
   ...
   .VAR/DMCONST_WINDOWED16 num_swb_long_window_512[NUM_SUPPORTED_FREQS_ELD] =
      36,   // 48000Hz
      36,   // 44100Hz
      37,   // 32000Hz
      31,   // 24000Hz
   ...
   .VAR/DMCONST_WINDOWED16 num_swb_long_window_480[NUM_SUPPORTED_FREQS_ELD] =
      35,   // 48000Hz
      35,   // 44100Hz
      37,   // 32000Hz
      30,   // 24000Hz
   ...
   .VAR/DMCONST_WINDOWED16 eld_swb_offset_long_48_512[] =  // 48000Hz long win, scalefactor band offsets
      0,   4,   8,   12,  16,  20,  24,  28,  32,  36,  40,  44,  48,  52,
      56,  60,  68,  76,  84,  92,  100, 112, 124, 136, 148, 164, 184, 208,
      236, 268, 300, 332, 364, 396, 428, 460, 512;

   .VAR/DMCONST_WINDOWED16 eld_swb_offset_long_32_512[] =  // 32000Hz long win, scalefactor band offsets
      0,   4,   8,   12,  16,  20,  24,  28,  32,  36,  40,  44,  48,  52,
      56,  64,  72,  80,  88,  96,  108, 120, 132, 144, 160, 176, 192, 212,
      236, 260, 288, 320, 352, 384, 416, 448, 480, 512;

   .VAR/DMCONST_WINDOWED16 eld_swb_offset_long_24_512[] =  // 24000Hz long win, scalefactor band offsets
      0,   4,   8,   12,  16,  20,  24,  28,  32,  36,  40,  44,  52,  60,
      68,  80,  92,  104, 120, 140, 164, 192, 224, 256, 288, 320, 352, 384, 
      416, 448, 480, 512;

   .VAR/DMCONST_WINDOWED16 eld_swb_offset_long_48_480[] =  // 48000Hz long win, scalefactor band offsets
      0,   4,   8,   12,  16,  20,  24,  28,  32,  36,  40,  44,  48,  52,
      56,  64,  72,  80,  88,  96,  108, 120, 132, 144, 156, 172, 188, 212, 
      240, 272, 304, 336, 368, 400, 432, 480;

   .VAR/DMCONST_WINDOWED16 eld_swb_offset_long_32_480[] =  // 32000Hz long win, scalefactor band offsets
      0,   4,   8,   12,  16,  20,  24,  28,  32,  36,  40,  44,  48,  52,
      56,  60,  64,  72,  80,  88,  96,  104, 112, 124, 136, 148, 164, 180,
      200, 224, 256, 288, 320, 352, 384, 416, 448, 480;

   .VAR/DMCONST_WINDOWED16 eld_swb_offset_long_24_480[] =  // 24000Hz long win, scalefactor band offsets
      0,   4,   8,   12,  16,  20,  24,  28,  32,  36,  40,  44,  52,  60,  
      68,  80,  92,  104, 120, 140, 164, 192, 224, 256, 288, 320, 352, 384,
      416, 448, 480;

   .VAR/DMCONST_WINDOWED16 swb_offset_long_table_512[NUM_SUPPORTED_FREQS_ELD] =
   ...
   .VAR/DMCONST_WINDOWED16 swb_offset_long_table_480[NUM_SUPPORTED_FREQS_ELD] =
