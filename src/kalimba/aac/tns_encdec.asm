...
.MODULE $M.aacdec.tns_encdec;
   ...
   // temporary variables needed in encoder mode due to runnning out of
   // index registers
   .VAR $aacdec.temp_I5;
      ...
      n_filt_loop:
         ...
         are_in_encode_mode:
            ...
            do inverse_quant_loop;       // lookup coef's from RAM
               ...
               M[I5,1] = r2;                // write over input value
            inverse_quant_loop:
         ...
         lpc_outer_loop:
            ...
            do lpc_calc_loop;
               ...
               rMAC = rMAC + r0*r1,
                r0 = M[I1,-1];       // a[m-i]
               M[I0,1] = rMAC,       // store b[i]
                rMAC = M[I4,1];      // load a[i]
            lpc_calc_loop:

            I4 = r2;              // I4 = &a[0]
            I1 = r3;              // I1 = &b[0]
            rMAC = M[I1,1];       // rMAC = b[0]
         ...
         r5 = M[$aacdec.tmp + 1];              // TNS_MAX_BANDS = $aacdec.tmp[1]
         ...
         r3 = M[$aacdec.tmp + 1];              // TNS_MAX_BANDS = $aacdec.tmp[1]
         Null = r3 - r1;                       // r1 = top
         if POS r3 = r1;
         ...
         r0 = r5 + M[$aacdec.current_spec_ptr];
         I0 = r0;
#ifndef AAC_USE_EXTERNAL_MEMORY
         r1 = r5 + &$aacdec.tmp_mem_pool;
#else 
         r1 = M[$aacdec.tmp_mem_pool_ptr];
         r1 = r5 + r1 ; // &$aacdec.tmp_mem_pool;
#endif 
         Null = M2;
         if NZ I0 = r1;
...
.MODULE $M.aacdec.fir_filter;
   ...
   I5 = &$aacdec.tns_fir_input_history;
   L5 = $aacdec.TNS_MAX_ORDER_LONG;

   // read pointer to the previous input values ( history of x() )
   I1 = &$aacdec.tns_fir_input_history;
   L1 = $aacdec.TNS_MAX_ORDER_LONG;
