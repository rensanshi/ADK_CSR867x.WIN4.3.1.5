...
.MODULE $M.aacdec.sbr_calc_chirp_factors;
   ...
   I1 = r0 + (&$aacdec.sbr_np_info + $aacdec.SBR_bs_invf_mode);
   I4 = r0 + (&$aacdec.sbr_info + $aacdec.SBR_bs_invf_mode_prev);
   I0 = r0 + (&$aacdec.sbr_info + $aacdec.SBR_bwArray);
