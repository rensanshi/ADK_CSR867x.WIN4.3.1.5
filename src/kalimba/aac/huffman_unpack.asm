...
.MODULE $M.aacdec.huffman_reset_unpacked_list;
   ...
   $aacdec.huffman_reset_unpacked_list:
      ...
      I1 = &$aacdec.huffman_cb_table;
      r10 = 12;
   #else
      I1 = &$aacdec.huffman_cb_table + 1;
      r10 = 11;
   #endif
...
.MODULE $M.aacdec.huffman_unpack_individual_flash_table;
   ...
   r0 = M[$aacdec.huffman_cb_table + r5];
   ...
   r10 = M[$aacdec.huffman_table_sizes_div_2 + r5];
   r0 = M[$aacdec.huffman_packed_list + r5];
   ...
   M[$aacdec.huffman_cb_table + r5] = r1;
   ...
   do flash_copy_loop;
      ...
      r1 = r1 LSHIFT 16;
      r0 = r0 + r1,
       M[I3,1] = r2;       // store 1st 24bit word
