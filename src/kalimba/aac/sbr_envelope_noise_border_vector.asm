...
.MODULE $M.aacdec.sbr_envelope_noise_border_vector;
   ...
   r0 = r5 * 6 (int);
   r2 = M[($aacdec.sbr_np_info + $aacdec.SBR_t_E) + r0];

   r1 = r5 * 3 (int);
   M[($aacdec.sbr_np_info + $aacdec.SBR_t_Q) + r1] = r2;

   r2 = M[($aacdec.sbr_np_info + $aacdec.SBR_bs_num_env) + r5];
   Null = r2 - 1;
   if NZ jump bs_num_env_ne_1;
      // SBR_t_Q[ch][1] = SBR_t_E[ch][1]
      r2 = M[($aacdec.sbr_np_info + $aacdec.SBR_t_E + 1) + r0];
      M[($aacdec.sbr_np_info + $aacdec.SBR_t_Q + 1) + r1] = r2;

      // SBR_t_Q[ch][2] = 0
      M[($aacdec.sbr_np_info + $aacdec.SBR_t_Q + 2) + r1] = Null;
   ...
   if LE jump $pop_rLink_and_rts;
      ...
      r3 = r3 + r0;
      r3 = M[($aacdec.sbr_np_info + $aacdec.SBR_t_E) + r3];
      M[($aacdec.sbr_np_info + $aacdec.SBR_t_Q + 1) + r1] = r3;
      // SBR_t_Q[ch][2] = SBR_t_E[ch][SBR_bs_num_env[ch]]
      r2 = r2 + r0;
      r2 = M[($aacdec.sbr_np_info + $aacdec.SBR_t_E) + r2];
      M[($aacdec.sbr_np_info + $aacdec.SBR_t_Q + 2) + r1] = r2;
