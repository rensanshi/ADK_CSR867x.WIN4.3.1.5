...
// Address of function to call is passed on the stack
.MODULE $M.call_c_with_int_return;
    .CODESEGMENT CALL_C_WITH_INT_RETURN;
$call_c_with_int_return:
    pushm <FP(=SP), rMAC, r1, r2, r3, r10, rLink>;
    ...
    popm <FP, rMAC, r1, r2, r3, r10, rLink>;
    rts;
.ENDMODULE;

// Address of function to call is passed on the stack
.MODULE $M.call_c_with_void_return;
    .CODESEGMENT CALL_C_WITH_VOID_RETURN;
$call_c_with_void_return:
    pushm <FP(=SP), rMAC, r0, r1, r2, r3, r10, rLink>;
    pushm <I3, I7, M0, M1, M2, M3, L0, L1, L4, L5>;
    M0 = 0;
    M1 = 1;
    M2 = -1;
    ...
    call rLink;
    popm <I3, I7, M0, M1, M2, M3, L0, L1, L4, L5>;
    popm <FP, rMAC, r0, r1, r2, r3, r10, rLink>;
    rts;
.ENDMODULE;
