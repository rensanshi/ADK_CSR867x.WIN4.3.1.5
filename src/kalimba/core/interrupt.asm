...
.MODULE $interrupt;
   ...
   .VAR total_time = 0;
      ...
      #endif
   #elif defined(VULTAN)
            .VAR isr_call_table[12] =
                $timer.service_routine,            // SOURCE_TIMER1
                $error,                            // SOURCE_TIMER2
                $message.received_service_routine, // SOURCE_MCU (XAP)
                $error,                            // SOURCE_PIO
                $error,                            // SOURCE_MMU_UNMAPPED
                $error,                            // SOURCE_SW0
                $error,                            // SOURCE_SW1
                $error,                            // SOURCE_SW2
                $error,                            // SOURCE_SW3
                $error,                            // SOURCE_KEYSCAN
                $error,                            // SOURCE_BITSERIAL
                $error;                            // SOURCE_BITSERIAL2
          
            #ifdef OPTIONAL_FAST_INTERRUPT_SUPPORT
            .VAR isr_fast_call_table[12] =
                0,                                 // SOURCE_TIMER1
                0,                                 // SOURCE_TIMER2
                0,                                 // SOURCE_MCU
                0,                                 // SOURCE_PIO
