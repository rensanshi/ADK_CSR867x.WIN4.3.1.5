// *****************************************************************************
// Copyright (c) 2008 - 2018 Qualcomm Technologies International, Ltd.         http://www.csr.com
// Part of ADK_CSR867x.WIN 4.3
//
// $Change: 2043806 $  $DateTime: 2014/12/01 18:07:05 $
// *****************************************************************************
...
#ifndef AUDIO_DH_PEQ_INCLUDED
#define AUDIO_DH_PEQ_INCLUDED
...
$audio_proc.dh_peq.initialize:
   ...
   LIBS_SLOW_SW_ROM_PATCH_POINT($audio_proc.DH_PEQ_ASM.INITIALIZE.PATCH_ID_0,r10) // af05_CVC_patches1
#endif
...
#if defined(PATCH_LIBS)
   LIBS_SLOW_SW_ROM_PATCH_POINT($audio_proc.DH_PEQ_ASM.ZERODELAY.PATCH_ID_0,r10) // af05_CVC_patches1
#endif
...
//
// TRASHED REGISTERS:
//    rMAC, r0-r6, r10, M0-M2, I0-I7, L0, L1, L4, L5, LOOP
//
// NOTES:
...
$audio_proc.dh_peq.process:
   ...
   push rLink;
#if defined(PATCH_LIBS)
   LIBS_SLOW_SW_ROM_PATCH_POINT($audio_proc.DH_PEQ_ASM.PROCESS.PATCH_ID_0,r1) // af05_CVC_patches1
#endif
...
$audio_proc.dh_peq.process_op:
   ...
   push r0;
   pop  B1;
   I1 = r0, r1 = M[I3,M1];              // I6 = NUM_STAGES_FIELD
   I6 = r1, r1 = M[I3,M1];              // L5 = DELAYLINE_SIZE_FIELD
   ...
   r9 = $audio_proc.peq.DH_PEQ_HEADROOM_SHIFTS;
   // Set Ptr to scale factors
   r2 = M[r7 + $audio_proc.peq.MAX_STAGES_FIELD];
   r2 = r2 * 5(int);
   I2 = I2 + r2, r2 = M[I1, 1];  // r2=b2
   I2 = I2 + I6;                        // end of scale factors (reset to beginnng below)
   I6 = Null - I6;
   r6 = r1 - r9;
   ...
   // I2       = scalefactor                    M2 = -3
   // I3       = param_ptr                      
   // I4/L4/B4 = x                              I6 = -num_stages
   // I5/L5/B5 = history                        I7 = sample_ct
   // r8/r6 = mantissa/exp                      r9 = headroom shifts
peq_block_loop:       
      // I5 = &x_N-2_L
      //  r10 = sample_ct, r0 = xN, r1 = xN-2_L
      r10 = r10 - I6, rMAC = M[I4,M1];
      // apply mantisa,Exp to front end gain, r3 = xN-2_H, backup scalefactor pointer, r0 = xN, r3 = xN-2_H
      I2 = I2 + I6;
      ...
      rMAC = rMAC ASHIFT r9 (56bit), M[I5,1] = r1;
      // Decrement the block counter,write back o/p sample, store new y(n-1)
      I7 = I7 - M1,  M[I0,M1] = rMAC, M[I5,M1] = r0;
