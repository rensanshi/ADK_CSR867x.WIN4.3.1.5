...
$audio_proc.peq.process_op:
   ...
   I2 = r0 + M1,    r0 = M[I3,M1];      // B5 = DELAYLINE_START_ADDR_FIELD
   // I5 = ptr to delay line,
   push r0;
   pop  B5, r0 = M[I3,M1]; // I5 = DELAYLINE_START_ADDR_FIELD
   ...
   r6 = r1 - $audio_proc.peq.PEQ_HEADROOM_SHIFTS;
   r1 = Null;
...
peq_block_loop:
      ...
      rMAC = rMACB ASHIFT $audio_proc.peq.PEQ_HEADROOM_SHIFTS (56bit);
