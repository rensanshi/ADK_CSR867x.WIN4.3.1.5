...
typedef struct
{
    ...
    unsigned            enable_current_limiting:1; /* Enable current limiting operation */
    unsigned            current_limiting_active:1;
    ...
    uint16              cumulative_non_current_limit_period_chg;
    uint16              calculated_external_resistance_in_milli_ohms;
