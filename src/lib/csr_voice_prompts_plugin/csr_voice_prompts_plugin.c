...
static void message_handler ( Task task, MessageId id, Message message ) 
{
    ...
    {
        VoicePromptsDspLongMessageHandler(VoicePromptsGetContext(), task, message) ;
    }
    else
    {
...
static void handleAudioMessage ( Task task , MessageId id, Message message )     
{
    ...
    {        
        case (AUDIO_PLUGIN_PLAY_AUDIO_PROMPT_MSG ):
        {
            ...
            CsrVoicePromptsPluginPlayPhrase(prompt_message->prompt_index,
                                            prompt_message->prompt_header_index,
                                            prompt_message->ap_volume,
        ...
        case (AUDIO_PLUGIN_PLAY_TONE_MSG ):
        {
            ...
            CsrVoicePromptsPluginPlayTone(tone_message->tone, tone_message->features);
        }
        break ;        
