                          ...
                          AUDIO_PLUGIN_CONNECT_MSG_T* connect_msg)
{
    ...
    /* Set clear mic pin */
    AudioPluginSetMicPio(CVC->voice_mic_params->mic_a, TRUE);
    if(task->two_mic)
        AudioPluginSetMicPio(CVC->voice_mic_params->mic_b, TRUE);
...
void CsrCvcPluginDisconnect( CvcPluginTaskdata *task )
{
    ...
    AudioPluginSetMicPio(CVC->voice_mic_params->mic_a, FALSE);
    if(task->two_mic)
        AudioPluginSetMicPio(CVC->voice_mic_params->mic_b, FALSE);
